...
KineticInt::~KineticInt() { delete[] buffer_; }
...
static double ke_int(double **x, double **y, double **z, double a1, int l1, int m1, int n1, double a2, int l2, int m2,
                     int n2) {
    double I1, I2, I3, I4;
                ...
                for (int jj = 0; jj <= ii; jj++) {
                    ...
                    for (int kk = 0; kk <= am2; kk++) {
                        ...
                        for (int ll = 0; ll <= kk; ll++) {
                            ...
                            if (l1) ix -= l1 * ke_int(x, y, z, a1, l1 - 1, m1, n1, a2, l2, m2, n2) * over_pf;
                            // y on center i
                            iy += 2.0 * a1 * ke_int(x, y, z, a1, l1, m1 + 1, n1, a2, l2, m2, n2) * over_pf;
                            if (m1) iy -= m1 * ke_int(x, y, z, a1, l1, m1 - 1, n1, a2, l2, m2, n2) * over_pf;
                            // z on center i
                            iz += 2.0 * a1 * ke_int(x, y, z, a1, l1, m1, n1 + 1, a2, l2, m2, n2) * over_pf;
                            if (n1) iz -= n1 * ke_int(x, y, z, a1, l1, m1, n1 - 1, a2, l2, m2, n2) * over_pf;
                            // x on center i,j
...
void KineticInt::compute_pair_deriv2(const GaussianShell &s1, const GaussianShell &s2) {
    int ao12;
    int am1 = s1.am();
    int am2 = s2.am();
    int nprim1 = s1.nprimitive();
                ...
                for (int jj = 0; jj <= ii; jj++) {
                    ...
                    for (int kk = 0; kk <= am2; kk++) {
                        ...
                        for (int ll = 0; ll <= kk; ll++) {
                            ...
                            // T_{\mu\nu}^{a_x a_x}
                            buffer_[(0 * size) + ao12] +=
                                (4.0 * a1 * a1 * ke_int(x, y, z, a1, l1 + 2, m1, n1, a2, l2, m2, n2) -
                                 2.0 * a1 * (2 * l1 + 1) * ke_int(x, y, z, a1, l1, m1, n1, a2, l2, m2, n2)) *
                                over_pf;
                            if (l1 > 1)
                                buffer_[(0 * size) + ao12] +=
                                    over_pf * l1 * (l1 - 1) * ke_int(x, y, z, a1, l1 - 2, m1, n1, a2, l2, m2, n2);

                            // T_{\mu\nu}^{a_x a_y}
                            buffer_[(1 * size) + ao12] +=
                                over_pf * 4.0 * a1 * a1 * ke_int(x, y, z, a1, l1 + 1, m1 + 1, n1, a2, l2, m2, n2);
                            if (l1)
                                buffer_[(1 * size) + ao12] -=
                                    over_pf * 2.0 * l1 * a1 * ke_int(x, y, z, a1, l1 - 1, m1 + 1, n1, a2, l2, m2, n2);
                            if (m1)
                                buffer_[(1 * size) + ao12] -=
                                    over_pf * 2.0 * m1 * a1 * ke_int(x, y, z, a1, l1 + 1, m1 - 1, n1, a2, l2, m2, n2);
                            if (l1 && m1)
                                buffer_[(1 * size) + ao12] +=
                                    over_pf * l1 * m1 * ke_int(x, y, z, a1, l1 - 1, m1 - 1, n1, a2, l2, m2, n2);

                            // T_{\mu\nu}^{a_x a_z}
                            buffer_[(2 * size) + ao12] +=
                                over_pf * 4.0 * a1 * a1 * ke_int(x, y, z, a1, l1 + 1, m1, n1 + 1, a2, l2, m2, n2);
                            if (l1)
                                buffer_[(2 * size) + ao12] -=
                                    over_pf * 2.0 * l1 * a1 * ke_int(x, y, z, a1, l1 - 1, m1, n1 + 1, a2, l2, m2, n2);
                            if (n1)
                                buffer_[(2 * size) + ao12] -=
                                    over_pf * 2.0 * n1 * a1 * ke_int(x, y, z, a1, l1 + 1, m1, n1 - 1, a2, l2, m2, n2);
                            if (l1 && n1)
                                buffer_[(2 * size) + ao12] +=
                                    over_pf * l1 * n1 * ke_int(x, y, z, a1, l1 - 1, m1, n1 - 1, a2, l2, m2, n2);

                            // T_{\mu\nu}^{a_y a_y}
                            buffer_[(3 * size) + ao12] +=
                                (4.0 * a1 * a1 * ke_int(x, y, z, a1, l1, m1 + 2, n1, a2, l2, m2, n2) -
                                 2.0 * a1 * (2 * m1 + 1) * ke_int(x, y, z, a1, l1, m1, n1, a2, l2, m2, n2)) *
                                over_pf;
                            if (m1 > 1)
                                buffer_[(3 * size) + ao12] +=
                                    over_pf * m1 * (m1 - 1) * ke_int(x, y, z, a1, l1, m1 - 2, n1, a2, l2, m2, n2);

                            // T_{\mu\nu}^{a_y a_z}
                            buffer_[(4 * size) + ao12] +=
                                over_pf * 4.0 * a1 * a1 * ke_int(x, y, z, a1, l1, m1 + 1, n1 + 1, a2, l2, m2, n2);
                            if (m1)
                                buffer_[(4 * size) + ao12] -=
                                    over_pf * 2.0 * m1 * a1 * ke_int(x, y, z, a1, l1, m1 - 1, n1 + 1, a2, l2, m2, n2);
                            if (n1)
                                buffer_[(4 * size) + ao12] -=
                                    over_pf * 2.0 * n1 * a1 * ke_int(x, y, z, a1, l1, m1 + 1, n1 - 1, a2, l2, m2, n2);
                            if (m1 && n1)
                                buffer_[(4 * size) + ao12] +=
                                    over_pf * m1 * n1 * ke_int(x, y, z, a1, l1, m1 - 1, n1 - 1, a2, l2, m2, n2);

                            // T_{\mu\nu}^{a_z a_z}
                            buffer_[(5 * size) + ao12] +=
                                (4.0 * a1 * a1 * ke_int(x, y, z, a1, l1, m1, n1 + 2, a2, l2, m2, n2) -
                                 2.0 * a1 * (2 * n1 + 1) * ke_int(x, y, z, a1, l1, m1, n1, a2, l2, m2, n2)) *
                                over_pf;
                            if (n1 > 1)
                                buffer_[(5 * size) + ao12] +=
                                    over_pf * n1 * (n1 - 1) * ke_int(x, y, z, a1, l1, m1, n1 - 2, a2, l2, m2, n2);
