...
int PSI_DBDSDC(int irrep, char uplo, char compq, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e,
    ...
    return C_DBDSDC(uplo, compq, n, d->pointer(irrep), e->pointer(irrep), u->pointer(irrep)[0], ldu,
                    vt->pointer(irrep)[0], ldvt, q->pointer(irrep), iq->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DBDSQR(int irrep, char uplo, int n, int ncvt, int nru, int ncc, std::shared_ptr<Vector> d,
    ...
    return C_DBDSQR(uplo, n, ncvt, nru, ncc, d->pointer(irrep), e->pointer(irrep), vt->pointer(irrep)[0], ldvt,
                    u->pointer(irrep)[0], ldu, c->pointer(irrep)[0], ldc, work->pointer(irrep));
}
...
int PSI_DGBBRD(int irrep, char vect, int m, int n, int ncc, int kl, int ku, SharedMatrix ab, int ldab,
    ...
    return C_DGBBRD(vect, m, n, ncc, kl, ku, ab->pointer(irrep)[0], ldab, d->pointer(irrep), e->pointer(irrep),
                    q->pointer(irrep)[0], ldq, pt->pointer(irrep)[0], ldpt, c->pointer(irrep)[0], ldc,
                    work->pointer(irrep));
}
...
int PSI_DGBCON(int irrep, char norm, int n, int kl, int ku, SharedMatrix ab, int ldab, std::shared_ptr<IntVector> ipiv,
    ...
    return C_DGBCON(norm, n, kl, ku, ab->pointer(irrep)[0], ldab, ipiv->pointer(irrep), anorm, rcond->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGBEQU(int irrep, int m, int n, int kl, int ku, SharedMatrix ab, int ldab, std::shared_ptr<Vector> r,
    ...
    return C_DGBEQU(m, n, kl, ku, ab->pointer(irrep)[0], ldab, r->pointer(irrep), c->pointer(irrep),
                    rowcnd->pointer(irrep), colcnd->pointer(irrep), amax->pointer(irrep));
}
...
int PSI_DGBRFS(int irrep, char trans, int n, int kl, int ku, int nrhs, SharedMatrix ab, int ldab, SharedMatrix afb,
               ...
               std::shared_ptr<IntVector> iwork) {
    return C_DGBRFS(trans, n, kl, ku, nrhs, ab->pointer(irrep)[0], ldab, afb->pointer(irrep)[0], ldafb,
                    ipiv->pointer(irrep), b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep),
                    berr->pointer(irrep), work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGBSVX(int irrep, char fact, char trans, int n, int kl, int ku, int nrhs, SharedMatrix ab, int ldab,
    ...
    return C_DGBSVX(fact, trans, n, kl, ku, nrhs, ab->pointer(irrep)[0], ldab, afb->pointer(irrep)[0], ldafb,
                    ipiv->pointer(irrep), equed, r->pointer(irrep), c->pointer(irrep), b->pointer(irrep)[0], ldb,
                    x->pointer(irrep)[0], ldx, rcond->pointer(irrep), ferr->pointer(irrep), berr->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGBTRS(int irrep, char trans, int n, int kl, int ku, int nrhs, SharedMatrix ab, int ldab,
    ...
    return C_DGBTRS(trans, n, kl, ku, nrhs, ab->pointer(irrep)[0], ldab, ipiv->pointer(irrep), b->pointer(irrep)[0],
                    ldb);
}
...
int PSI_DGEBRD(int irrep, int m, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e,
    ...
    return C_DGEBRD(m, n, a->pointer(irrep)[0], lda, d->pointer(irrep), e->pointer(irrep), tauq->pointer(irrep),
                    taup->pointer(irrep), work->pointer(irrep), lwork);
}
...
int PSI_DGECON(int irrep, char norm, int n, SharedMatrix a, int lda, double anorm, std::shared_ptr<Vector> rcond,
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DGECON(norm, n, a->pointer(irrep)[0], lda, anorm, rcond->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DGEEQU(int irrep, int m, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> r, std::shared_ptr<Vector> c,
    ...
    return C_DGEEQU(m, n, a->pointer(irrep)[0], lda, r->pointer(irrep), c->pointer(irrep), rowcnd->pointer(irrep),
                    colcnd->pointer(irrep), amax->pointer(irrep));
}
...
int PSI_DGEES(int irrep, char jobvs, char sort, int n, SharedMatrix a, int lda, std::shared_ptr<IntVector> sdim,
    ...
    return C_DGEES(jobvs, sort, n, a->pointer(irrep)[0], lda, sdim->pointer(irrep), wr->pointer(irrep),
                   wi->pointer(irrep), vs->pointer(irrep)[0], ldvs, work->pointer(irrep), lwork);
}
...
int PSI_DGEESX(int irrep, char jobvs, char sort, char sense, int n, SharedMatrix a, int lda,
    ...
    return C_DGEESX(jobvs, sort, sense, n, a->pointer(irrep)[0], lda, sdim->pointer(irrep), wr->pointer(irrep),
                    wi->pointer(irrep), vs->pointer(irrep)[0], ldvs, rconde->pointer(irrep), rcondv->pointer(irrep),
                    work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DGEEV(int irrep, char jobvl, char jobvr, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> wr,
    ...
    return C_DGEEV(jobvl, jobvr, n, a->pointer(irrep)[0], lda, wr->pointer(irrep), wi->pointer(irrep),
                   vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0], ldvr, work->pointer(irrep), lwork);
}
...
int PSI_DGEEVX(int irrep, char balanc, char jobvl, char jobvr, char sense, int n, SharedMatrix a, int lda,
    ...
    return C_DGEEVX(balanc, jobvl, jobvr, sense, n, a->pointer(irrep)[0], lda, wr->pointer(irrep), wi->pointer(irrep),
                    vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0], ldvr, ilo->pointer(irrep), ihi->pointer(irrep),
...
int PSI_DGELS(int irrep, char trans, int m, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix b, int ldb,
              std::shared_ptr<Vector> work, int lwork) {
    return C_DGELS(trans, m, n, nrhs, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, work->pointer(irrep),
                   lwork);
}
...
int PSI_DGELSD(int irrep, int m, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix b, int ldb,
    ...
    return C_DGELSD(m, n, nrhs, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, s->pointer(irrep), rcond,
                    rank->pointer(irrep), work->pointer(irrep), lwork, iwork->pointer(irrep));
}
...
int PSI_DGELSY(int irrep, int m, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               std::shared_ptr<IntVector> jpvt, double rcond, std::shared_ptr<IntVector> rank,
               std::shared_ptr<Vector> work, int lwork) {
    return C_DGELSY(m, n, nrhs, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, jpvt->pointer(irrep), rcond,
                    rank->pointer(irrep), work->pointer(irrep), lwork);
}
...
int PSI_DGERFS(int irrep, char trans, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
               ...
               std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work,
               std::shared_ptr<IntVector> iwork) {
    return C_DGERFS(trans, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, ipiv->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGESDD(int irrep, char jobz, int m, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> s, SharedMatrix u,
               ...
               std::shared_ptr<IntVector> iwork) {
    return C_DGESDD(jobz, m, n, a->pointer(irrep)[0], lda, s->pointer(irrep), u->pointer(irrep)[0], ldu,
                    vt->pointer(irrep)[0], ldvt, work->pointer(irrep), lwork, iwork->pointer(irrep));
}
...
int PSI_DGESVX(int irrep, char fact, char trans, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
               ...
               std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work,
               std::shared_ptr<IntVector> iwork) {
    return C_DGESVX(fact, trans, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, ipiv->pointer(irrep),
                    equed, r->pointer(irrep), c->pointer(irrep), b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx,
                    rcond->pointer(irrep), ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DGGBAK(int irrep, char job, char side, int n, int ilo, int ihi, std::shared_ptr<Vector> lscale,
    ...
    return C_DGGBAK(job, side, n, ilo, ihi, lscale->pointer(irrep), rscale->pointer(irrep), m, v->pointer(irrep)[0],
                    ldv);
}
...
int PSI_DGGBAL(int irrep, char job, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
    ...
    return C_DGGBAL(job, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, ilo->pointer(irrep),
                    ihi->pointer(irrep), lscale->pointer(irrep), rscale->pointer(irrep), work->pointer(irrep));
}
...
int PSI_DGGES(int irrep, char jobvsl, char jobvsr, char sort, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
              ...
              std::shared_ptr<Vector> work, int lwork) {
    return C_DGGES(jobvsl, jobvsr, sort, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, sdim->pointer(irrep),
                   alphar->pointer(irrep), alphai->pointer(irrep), beta->pointer(irrep), vsl->pointer(irrep)[0], ldvsl,
                   vsr->pointer(irrep)[0], ldvsr, work->pointer(irrep), lwork);
}
...
int PSI_DGGESX(int irrep, char jobvsl, char jobvsr, char sort, char sense, int n, SharedMatrix a, int lda,
    ...
    return C_DGGESX(jobvsl, jobvsr, sort, sense, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb,
                    sdim->pointer(irrep), alphar->pointer(irrep), alphai->pointer(irrep), beta->pointer(irrep),
                    vsl->pointer(irrep)[0], ldvsl, vsr->pointer(irrep)[0], ldvsr, rconde->pointer(irrep),
                    rcondv->pointer(irrep), work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DGGEV(int irrep, char jobvl, char jobvr, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
              std::shared_ptr<Vector> alphar, std::shared_ptr<Vector> alphai, std::shared_ptr<Vector> beta,
              SharedMatrix vl, int ldvl, SharedMatrix vr, int ldvr, std::shared_ptr<Vector> work, int lwork) {
    return C_DGGEV(jobvl, jobvr, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, alphar->pointer(irrep),
                   alphai->pointer(irrep), beta->pointer(irrep), vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0],
                   ldvr, work->pointer(irrep), lwork);
}
...
int PSI_DGGEVX(int irrep, char balanc, char jobvl, char jobvr, char sense, int n, SharedMatrix a, int lda,
               ...
               std::shared_ptr<IntVector> iwork) {
    return C_DGGEVX(balanc, jobvl, jobvr, sense, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb,
                    alphar->pointer(irrep), alphai->pointer(irrep), beta->pointer(irrep), vl->pointer(irrep)[0], ldvl,
                    vr->pointer(irrep)[0], ldvr, ilo->pointer(irrep), ihi->pointer(irrep), lscale->pointer(irrep),
                    rscale->pointer(irrep), abnrm->pointer(irrep), bbnrm->pointer(irrep), rconde->pointer(irrep),
                    rcondv->pointer(irrep), work->pointer(irrep), lwork, iwork->pointer(irrep));
}
...
int PSI_DGGGLM(int irrep, int n, int m, int p, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               std::shared_ptr<Vector> work, int lwork) {
    return C_DGGGLM(n, m, p, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, d->pointer(irrep), x->pointer(irrep),
                    y->pointer(irrep), work->pointer(irrep), lwork);
}
...
int PSI_DGGHRD(int irrep, char compq, char compz, int n, int ilo, int ihi, SharedMatrix a, int lda, SharedMatrix b,
    ...
    return C_DGGHRD(compq, compz, n, ilo, ihi, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb,
                    q->pointer(irrep)[0], ldq, z->pointer(irrep)[0], ldz);
}
...
int PSI_DGGLSE(int irrep, int m, int n, int p, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               std::shared_ptr<Vector> work, int lwork) {
    return C_DGGLSE(m, n, p, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, c->pointer(irrep), d->pointer(irrep),
                    x->pointer(irrep), work->pointer(irrep), lwork);
}
...
int PSI_DGGQRF(int irrep, int n, int m, int p, SharedMatrix a, int lda, std::shared_ptr<Vector> taua, SharedMatrix b,
    ...
    return C_DGGQRF(n, m, p, a->pointer(irrep)[0], lda, taua->pointer(irrep), b->pointer(irrep)[0], ldb,
...
int PSI_DGTCON(int irrep, char norm, int n, std::shared_ptr<Vector> dl, std::shared_ptr<Vector> d,
    ...
    return C_DGTCON(norm, n, dl->pointer(irrep), d->pointer(irrep), du->pointer(irrep), du2->pointer(irrep),
                    ipiv->pointer(irrep), anorm, rcond->pointer(irrep), work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGTRFS(int irrep, char trans, int n, int nrhs, std::shared_ptr<Vector> dl, std::shared_ptr<Vector> d,
    ...
    return C_DGTRFS(trans, n, nrhs, dl->pointer(irrep), d->pointer(irrep), du->pointer(irrep), dlf->pointer(irrep),
                    df->pointer(irrep), duf->pointer(irrep), du2->pointer(irrep), ipiv->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DGTSVX(int irrep, char fact, char trans, int n, int nrhs, std::shared_ptr<Vector> dl, std::shared_ptr<Vector> d,
               ...
               std::shared_ptr<Vector> duf, std::shared_ptr<Vector> du2, std::shared_ptr<IntVector> ipiv,
               SharedMatrix b, int ldb, SharedMatrix x, int ldx, std::shared_ptr<Vector> rcond) {
    return C_DGTSVX(fact, trans, n, nrhs, dl->pointer(irrep), d->pointer(irrep), du->pointer(irrep),
                    dlf->pointer(irrep), df->pointer(irrep), duf->pointer(irrep), du2->pointer(irrep),
                    ipiv->pointer(irrep), b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, rcond->pointer(irrep));
}
...
int PSI_DGTTRF(int irrep, int n, std::shared_ptr<Vector> dl, std::shared_ptr<Vector> d, std::shared_ptr<Vector> du,
    ...
    return C_DGTTRF(n, dl->pointer(irrep), d->pointer(irrep), du->pointer(irrep), du2->pointer(irrep),
                    ipiv->pointer(irrep));
}
...
int PSI_DGTTRS(int irrep, char trans, int n, int nrhs, std::shared_ptr<Vector> dl, std::shared_ptr<Vector> d,
               ...
               int ldb) {
    return C_DGTTRS(trans, n, nrhs, dl->pointer(irrep), d->pointer(irrep), du->pointer(irrep), du2->pointer(irrep),
                    ipiv->pointer(irrep), b->pointer(irrep)[0], ldb);
}
...
int PSI_DHGEQZ(int irrep, char job, char compq, char compz, int n, int ilo, int ihi, SharedMatrix h, int ldh,
               ...
               std::shared_ptr<Vector> work, int lwork) {
    return C_DHGEQZ(job, compq, compz, n, ilo, ihi, h->pointer(irrep)[0], ldh, t->pointer(irrep)[0], ldt,
                    alphar->pointer(irrep), alphai->pointer(irrep), beta->pointer(irrep), q->pointer(irrep)[0], ldq,
                    z->pointer(irrep)[0], ldz, work->pointer(irrep), lwork);
}
...
int PSI_DHSEIN(int irrep, char side, char eigsrc, char initv, int n, SharedMatrix h, int ldh,
    ...
    return C_DHSEIN(side, eigsrc, initv, n, h->pointer(irrep)[0], ldh, wr->pointer(irrep), wi->pointer(irrep),
                    vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0], ldvr, mm, m->pointer(irrep),
                    work->pointer(irrep), ifaill->pointer(irrep), ifailr->pointer(irrep));
}
...
int PSI_DHSEQR(int irrep, char job, char compz, int n, int ilo, int ihi, SharedMatrix h, int ldh,
               ...
               std::shared_ptr<Vector> work, int lwork) {
    return C_DHSEQR(job, compz, n, ilo, ihi, h->pointer(irrep)[0], ldh, wr->pointer(irrep), wi->pointer(irrep),
                    z->pointer(irrep)[0], ldz, work->pointer(irrep), lwork);
}
...
int PSI_DORMBR(int irrep, char vect, char side, char trans, int m, int n, int k, std::shared_ptr<Vector> a, int lda,
    ...
    return C_DORMBR(vect, side, trans, m, n, k, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMHR(int irrep, char side, char trans, int m, int n, int ilo, int ihi, std::shared_ptr<Vector> a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMHR(side, trans, m, n, ilo, ihi, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMLQ(int irrep, char side, char trans, int m, int n, int k, std::shared_ptr<Vector> a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMLQ(side, trans, m, n, k, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMQL(int irrep, char side, char trans, int m, int n, int k, SharedMatrix a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMQL(side, trans, m, n, k, a->pointer(irrep)[0], lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMQR(int irrep, char side, char trans, int m, int n, int k, SharedMatrix a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMQR(side, trans, m, n, k, a->pointer(irrep)[0], lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMR3(int irrep, char side, char trans, int m, int n, int k, int l, std::shared_ptr<Vector> a, int lda,
    ...
    return C_DORMR3(side, trans, m, n, k, l, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep));
}
...
int PSI_DORMRQ(int irrep, char side, char trans, int m, int n, int k, std::shared_ptr<Vector> a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMRQ(side, trans, m, n, k, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMRZ(int irrep, char side, char trans, int m, int n, int k, int l, std::shared_ptr<Vector> a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMRZ(side, trans, m, n, k, l, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DORMTR(int irrep, char side, char uplo, char trans, int m, int n, std::shared_ptr<Vector> a, int lda,
               std::shared_ptr<Vector> tau, SharedMatrix c, int ldc, std::shared_ptr<Vector> work, int lwork) {
    return C_DORMTR(side, uplo, trans, m, n, a->pointer(irrep), lda, tau->pointer(irrep), c->pointer(irrep)[0], ldc,
                    work->pointer(irrep), lwork);
}
...
int PSI_DPBCON(int irrep, char uplo, int n, int kd, SharedMatrix ab, int ldab, double anorm,
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPBCON(uplo, n, kd, ab->pointer(irrep)[0], ldab, anorm, rcond->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DPBEQU(int irrep, char uplo, int n, int kd, SharedMatrix ab, int ldab, std::shared_ptr<Vector> s,
    ...
    return C_DPBEQU(uplo, n, kd, ab->pointer(irrep)[0], ldab, s->pointer(irrep), scond->pointer(irrep),
                    amax->pointer(irrep));
}
...
int PSI_DPBRFS(int irrep, char uplo, int n, int kd, int nrhs, SharedMatrix ab, int ldab, SharedMatrix afb, int ldafb,
               SharedMatrix b, int ldb, SharedMatrix x, int ldx, std::shared_ptr<Vector> ferr,
               std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPBRFS(uplo, n, kd, nrhs, ab->pointer(irrep)[0], ldab, afb->pointer(irrep)[0], ldafb, b->pointer(irrep)[0],
                    ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DPBSVX(int irrep, char fact, char uplo, int n, int kd, int nrhs, SharedMatrix ab, int ldab, SharedMatrix afb,
               ...
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr,
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPBSVX(fact, uplo, n, kd, nrhs, ab->pointer(irrep)[0], ldab, afb->pointer(irrep)[0], ldafb, equed,
                    s->pointer(irrep), b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, rcond->pointer(irrep),
                    ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DPOCON(int irrep, char uplo, int n, SharedMatrix a, int lda, double anorm, std::shared_ptr<Vector> rcond,
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPOCON(uplo, n, a->pointer(irrep)[0], lda, anorm, rcond->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DPORFS(int irrep, char uplo, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
               SharedMatrix b, int ldb, SharedMatrix x, int ldx, std::shared_ptr<Vector> ferr,
               std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPORFS(uplo, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, b->pointer(irrep)[0], ldb,
                    x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DPOSVX(int irrep, char fact, char uplo, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
               ...
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr,
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DPOSVX(fact, uplo, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, equed,
                    s->pointer(irrep), b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, rcond->pointer(irrep),
                    ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DPTRFS(int irrep, int n, int nrhs, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e,
               ...
               std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work) {
    return C_DPTRFS(n, nrhs, d->pointer(irrep), e->pointer(irrep), df->pointer(irrep), ef->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep),
                    work->pointer(irrep));
}
...
int PSI_DPTSVX(int irrep, char fact, int n, int nrhs, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e,
               ...
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr,
               std::shared_ptr<Vector> work) {
    return C_DPTSVX(fact, n, nrhs, d->pointer(irrep), e->pointer(irrep), df->pointer(irrep), ef->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, rcond->pointer(irrep), ferr->pointer(irrep),
                    berr->pointer(irrep), work->pointer(irrep));
}
...
int PSI_DSBEV(int irrep, char jobz, char uplo, int n, int kd, SharedMatrix ab, int ldab, std::shared_ptr<Vector> w,
    ...
    return C_DSBEV(jobz, uplo, n, kd, ab->pointer(irrep)[0], ldab, w->pointer(irrep), z->pointer(irrep)[0], ldz,
                   work->pointer(irrep));
}
...
int PSI_DSBEVD(int irrep, char jobz, char uplo, int n, int kd, SharedMatrix ab, int ldab, std::shared_ptr<Vector> w,
               ...
               int liwork) {
    return C_DSBEVD(jobz, uplo, n, kd, ab->pointer(irrep)[0], ldab, w->pointer(irrep), z->pointer(irrep)[0], ldz,
                    work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DSBEVX(int irrep, char jobz, char range, char uplo, int n, int kd, SharedMatrix ab, int ldab, SharedMatrix q,
    ...
    return C_DSBEVX(jobz, range, uplo, n, kd, ab->pointer(irrep)[0], ldab, q->pointer(irrep)[0], ldq, vl, vu, il, iu,
                    abstol, m->pointer(irrep), w->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep),
                    iwork->pointer(irrep), ifail->pointer(irrep));
}
...
int PSI_DSBGST(int irrep, char vect, char uplo, int n, int ka, int kb, SharedMatrix ab, int ldab, SharedMatrix bb,
    ...
    return C_DSBGST(vect, uplo, n, ka, kb, ab->pointer(irrep)[0], ldab, bb->pointer(irrep)[0], ldbb,
                    x->pointer(irrep)[0], ldx, work->pointer(irrep));
}
...
int PSI_DSBGV(int irrep, char jobz, char uplo, int n, int ka, int kb, SharedMatrix ab, int ldab, SharedMatrix bb,
    ...
    return C_DSBGV(jobz, uplo, n, ka, kb, ab->pointer(irrep)[0], ldab, bb->pointer(irrep)[0], ldbb, w->pointer(irrep),
                   z->pointer(irrep)[0], ldz, work->pointer(irrep));
}
...
int PSI_DSBGVD(int irrep, char jobz, char uplo, int n, int ka, int kb, SharedMatrix ab, int ldab, SharedMatrix bb,
    ...
    return C_DSBGVD(jobz, uplo, n, ka, kb, ab->pointer(irrep)[0], ldab, bb->pointer(irrep)[0], ldbb, w->pointer(irrep),
                    z->pointer(irrep)[0], ldz, work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DSBGVX(int irrep, char jobz, char range, char uplo, int n, int ka, int kb, SharedMatrix ab, int ldab,
    ...
    return C_DSBGVX(jobz, range, uplo, n, ka, kb, ab->pointer(irrep)[0], ldab, bb->pointer(irrep)[0], ldbb,
                    q->pointer(irrep)[0], ldq, vl, vu, il, iu, abstol, m->pointer(irrep), w->pointer(irrep),
                    z->pointer(irrep)[0], ldz, work->pointer(irrep), iwork->pointer(irrep), ifail->pointer(irrep));
}
...
int PSI_DSBTRD(int irrep, char vect, char uplo, int n, int kd, SharedMatrix ab, int ldab, std::shared_ptr<Vector> d,
    ...
    return C_DSBTRD(vect, uplo, n, kd, ab->pointer(irrep)[0], ldab, d->pointer(irrep), e->pointer(irrep),
                    q->pointer(irrep)[0], ldq, work->pointer(irrep));
}
...
int PSI_DSGESV(int irrep, int n, int nrhs, std::shared_ptr<Vector> a, int lda, std::shared_ptr<IntVector> ipiv,
    ...
    return C_DSGESV(n, nrhs, a->pointer(irrep), lda, ipiv->pointer(irrep), b->pointer(irrep)[0], ldb,
                    x->pointer(irrep)[0], ldx, work->pointer(irrep)[0], iter->pointer(irrep));
}
...
int PSI_DSTEBZ(int irrep, char range, char order, int n, double vl, double vu, int il, int iu, double abstol,
    ...
    return C_DSTEBZ(range, order, n, vl, vu, il, iu, abstol, d->pointer(irrep), e->pointer(irrep), m->pointer(irrep),
                    nsplit->pointer(irrep), w->pointer(irrep), iblock->pointer(irrep), isplit->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DSTEDC(int irrep, char compz, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, SharedMatrix z,
    ...
    return C_DSTEDC(compz, n, d->pointer(irrep), e->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep),
                    lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DSTEGR(int irrep, char jobz, char range, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, double vl,
               ...
               std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DSTEGR(jobz, range, n, d->pointer(irrep), e->pointer(irrep), vl, vu, il, iu, abstol, m->pointer(irrep),
                    w->pointer(irrep), z->pointer(irrep)[0], ldz, isuppz->pointer(irrep), work->pointer(irrep), lwork,
                    iwork->pointer(irrep), liwork);
}
...
int PSI_DSTEIN(int irrep, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, int m, std::shared_ptr<Vector> w,
               ...
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork, std::shared_ptr<IntVector> ifail) {
    return C_DSTEIN(n, d->pointer(irrep), e->pointer(irrep), m, w->pointer(irrep), iblock->pointer(irrep),
                    isplit->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep), iwork->pointer(irrep),
                    ifail->pointer(irrep));
}
...
int PSI_DSTEVD(int irrep, char jobz, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, SharedMatrix z,
               int ldz, std::shared_ptr<Vector> work, int lwork, std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DSTEVD(jobz, n, d->pointer(irrep), e->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep),
                    lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DSTEVR(int irrep, char jobz, char range, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, double vl,
               ...
               SharedMatrix z, int ldz, std::shared_ptr<IntVector> isuppz, std::shared_ptr<Vector> work, int lwork,
               std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DSTEVR(jobz, range, n, d->pointer(irrep), e->pointer(irrep), vl, vu, il, iu, abstol, m->pointer(irrep),
                    w->pointer(irrep), z->pointer(irrep)[0], ldz, isuppz->pointer(irrep), work->pointer(irrep), lwork,
                    iwork->pointer(irrep), liwork);
}
...
int PSI_DSTEVX(int irrep, char jobz, char range, int n, std::shared_ptr<Vector> d, std::shared_ptr<Vector> e, double vl,
    ...
    return C_DSTEVX(jobz, range, n, d->pointer(irrep), e->pointer(irrep), vl, vu, il, iu, abstol, m->pointer(irrep),
                    w->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep), iwork->pointer(irrep),
                    ifail->pointer(irrep));
}
...
int PSI_DSYCON(int irrep, char uplo, int n, SharedMatrix a, int lda, std::shared_ptr<IntVector> ipiv, double anorm,
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DSYCON(uplo, n, a->pointer(irrep)[0], lda, ipiv->pointer(irrep), anorm, rcond->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DSYEVD(int irrep, char jobz, char uplo, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> w,
               std::shared_ptr<Vector> work, int lwork, std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DSYEVD(jobz, uplo, n, a->pointer(irrep)[0], lda, w->pointer(irrep), work->pointer(irrep), lwork,
                    iwork->pointer(irrep), liwork);
}
...
int PSI_DSYEVR(int irrep, char jobz, char range, char uplo, int n, SharedMatrix a, int lda, double vl, double vu,
               ...
               std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DSYEVR(jobz, range, uplo, n, a->pointer(irrep)[0], lda, vl, vu, il, iu, abstol, m->pointer(irrep),
                    w->pointer(irrep), z->pointer(irrep)[0], ldz, isuppz->pointer(irrep), work->pointer(irrep), lwork,
                    iwork->pointer(irrep), liwork);
}
...
int PSI_DSYEVX(int irrep, char jobz, char range, char uplo, int n, SharedMatrix a, int lda, double vl, double vu,
               ...
               std::shared_ptr<IntVector> ifail) {
    return C_DSYEVX(jobz, range, uplo, n, a->pointer(irrep)[0], lda, vl, vu, il, iu, abstol, m->pointer(irrep),
                    w->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep), lwork, iwork->pointer(irrep),
                    ifail->pointer(irrep));
}
...
int PSI_DSYGV(int irrep, int itype, char jobz, char uplo, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
    ...
    return C_DSYGV(itype, jobz, uplo, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, w->pointer(irrep),
                   work->pointer(irrep), lwork);
}
...
int PSI_DSYGVD(int irrep, int itype, char jobz, char uplo, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               int liwork) {
    return C_DSYGVD(itype, jobz, uplo, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, w->pointer(irrep),
                    work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DSYGVX(int irrep, int itype, char jobz, char range, char uplo, int n, SharedMatrix a, int lda, SharedMatrix b,
               ...
               std::shared_ptr<IntVector> iwork, std::shared_ptr<IntVector> ifail) {
    return C_DSYGVX(itype, jobz, range, uplo, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, vl, vu, il, iu,
                    abstol, m->pointer(irrep), w->pointer(irrep), z->pointer(irrep)[0], ldz, work->pointer(irrep),
                    lwork, iwork->pointer(irrep), ifail->pointer(irrep));
}
...
int PSI_DSYRFS(int irrep, char uplo, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
               ...
               std::shared_ptr<Vector> ferr, std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work,
               std::shared_ptr<IntVector> iwork) {
    return C_DSYRFS(uplo, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, ipiv->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep),
                    work->pointer(irrep), iwork->pointer(irrep));
}
...
int PSI_DSYSVX(int irrep, char fact, char uplo, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix af, int ldaf,
    ...
    return C_DSYSVX(fact, uplo, n, nrhs, a->pointer(irrep)[0], lda, af->pointer(irrep)[0], ldaf, ipiv->pointer(irrep),
                    b->pointer(irrep)[0], ldb, x->pointer(irrep)[0], ldx, rcond->pointer(irrep));
}
...
int PSI_DSYTRD(int irrep, char uplo, int n, SharedMatrix a, int lda, std::shared_ptr<Vector> d,
    ...
    return C_DSYTRD(uplo, n, a->pointer(irrep)[0], lda, d->pointer(irrep), e->pointer(irrep), tau->pointer(irrep),
                    work->pointer(irrep), lwork);
}
...
int PSI_DTBCON(int irrep, char norm, char uplo, char diag, int n, int kd, SharedMatrix ab, int ldab,
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DTBCON(norm, uplo, diag, n, kd, ab->pointer(irrep)[0], ldab, rcond->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DTBRFS(int irrep, char uplo, char trans, char diag, int n, int kd, int nrhs, SharedMatrix ab, int ldab,
               SharedMatrix b, int ldb, SharedMatrix x, int ldx, std::shared_ptr<Vector> ferr,
               std::shared_ptr<Vector> berr, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DTBRFS(uplo, trans, diag, n, kd, nrhs, ab->pointer(irrep)[0], ldab, b->pointer(irrep)[0], ldb,
                    x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DTGEVC(int irrep, char side, char howmny, int n, SharedMatrix s, int lds, SharedMatrix p, int ldp,
               ...
               std::shared_ptr<Vector> work) {
    return C_DTGEVC(side, howmny, n, s->pointer(irrep)[0], lds, p->pointer(irrep)[0], ldp, vl->pointer(irrep)[0], ldvl,
                    vr->pointer(irrep)[0], ldvr, mm, m->pointer(irrep), work->pointer(irrep));
}
...
int PSI_DTGEXC(int irrep, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb, SharedMatrix q, int ldq,
               ...
               std::shared_ptr<Vector> work, int lwork) {
    return C_DTGEXC(n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, q->pointer(irrep)[0], ldq,
                    z->pointer(irrep)[0], ldz, ifst->pointer(irrep), ilst->pointer(irrep), work->pointer(irrep), lwork);
}
...
int PSI_DTGSEN(int irrep, int ijob, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               std::shared_ptr<Vector> work, int lwork, std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DTGSEN(ijob, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, alphar->pointer(irrep),
                    alphai->pointer(irrep), beta->pointer(irrep), q->pointer(irrep)[0], ldq, z->pointer(irrep)[0], ldz,
                    m->pointer(irrep), pl->pointer(irrep), pr->pointer(irrep), dif->pointer(irrep),
                    work->pointer(irrep), lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DTGSJA(int irrep, char jobu, char jobv, char jobq, int m, int p, int n, int k, int l, SharedMatrix a, int lda,
    ...
    return C_DTGSJA(jobu, jobv, jobq, m, p, n, k, l, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, tola, tolb,
                    alpha->pointer(irrep), beta->pointer(irrep), u->pointer(irrep)[0], ldu, v->pointer(irrep)[0], ldv,
                    q->pointer(irrep)[0], ldq, work->pointer(irrep), ncycle->pointer(irrep));
}
...
int PSI_DTGSNA(int irrep, char job, char howmny, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               int lwork, std::shared_ptr<IntVector> iwork) {
    return C_DTGSNA(job, howmny, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, vl->pointer(irrep)[0], ldvl,
                    vr->pointer(irrep)[0], ldvr, s->pointer(irrep), dif->pointer(irrep), mm, m->pointer(irrep),
                    work->pointer(irrep), lwork, iwork->pointer(irrep));
}
...
int PSI_DTGSYL(int irrep, char trans, int ijob, int m, int n, SharedMatrix a, int lda, SharedMatrix b, int ldb,
               ...
               std::shared_ptr<IntVector> iwork) {
    return C_DTGSYL(trans, ijob, m, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb, c->pointer(irrep)[0], ldc,
                    d->pointer(irrep)[0], ldd, e->pointer(irrep)[0], lde, f->pointer(irrep)[0], ldf,
                    dif->pointer(irrep), scale->pointer(irrep), work->pointer(irrep), lwork, iwork->pointer(irrep));
}
...
int PSI_DTRCON(int irrep, char norm, char uplo, char diag, int n, SharedMatrix a, int lda,
               std::shared_ptr<Vector> rcond, std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DTRCON(norm, uplo, diag, n, a->pointer(irrep)[0], lda, rcond->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DTREVC(int irrep, char side, char howmny, int n, SharedMatrix t, int ldt, SharedMatrix vl, int ldvl,
    ...
    return C_DTREVC(side, howmny, n, t->pointer(irrep)[0], ldt, vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0],
                    ldvr, mm, m->pointer(irrep), work->pointer(irrep));
}
...
int PSI_DTREXC(int irrep, char compq, int n, SharedMatrix t, int ldt, SharedMatrix q, int ldq,
    ...
    return C_DTREXC(compq, n, t->pointer(irrep)[0], ldt, q->pointer(irrep)[0], ldq, ifst->pointer(irrep),
                    ilst->pointer(irrep), work->pointer(irrep));
}
...
int PSI_DTRRFS(int irrep, char uplo, char trans, char diag, int n, int nrhs, SharedMatrix a, int lda, SharedMatrix b,
               ...
               std::shared_ptr<Vector> work, std::shared_ptr<IntVector> iwork) {
    return C_DTRRFS(uplo, trans, diag, n, nrhs, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb,
                    x->pointer(irrep)[0], ldx, ferr->pointer(irrep), berr->pointer(irrep), work->pointer(irrep),
                    iwork->pointer(irrep));
}
...
int PSI_DTRSEN(int irrep, char job, char compq, int n, SharedMatrix t, int ldt, SharedMatrix q, int ldq,
               ...
               std::shared_ptr<IntVector> iwork, int liwork) {
    return C_DTRSEN(job, compq, n, t->pointer(irrep)[0], ldt, q->pointer(irrep)[0], ldq, wr->pointer(irrep),
                    wi->pointer(irrep), m->pointer(irrep), s->pointer(irrep), sep->pointer(irrep), work->pointer(irrep),
                    lwork, iwork->pointer(irrep), liwork);
}
...
int PSI_DTRSNA(int irrep, char job, char howmny, int n, SharedMatrix t, int ldt, SharedMatrix vl, int ldvl,
    ...
    return C_DTRSNA(job, howmny, n, t->pointer(irrep)[0], ldt, vl->pointer(irrep)[0], ldvl, vr->pointer(irrep)[0], ldvr,
                    s->pointer(irrep), sep->pointer(irrep), mm, m->pointer(irrep), work->pointer(irrep)[0], ldwork,
                    iwork->pointer(irrep));
}
...
int PSI_DTRSYL(int irrep, char trana, char tranb, int isgn, int m, int n, SharedMatrix a, int lda, SharedMatrix b,
    ...
    return C_DTRSYL(trana, tranb, isgn, m, n, a->pointer(irrep)[0], lda, b->pointer(irrep)[0], ldb,
                    c->pointer(irrep)[0], ldc, scale->pointer(irrep));
}
