...
ObaraSaikaTwoCenterMIRecursion::ObaraSaikaTwoCenterMIRecursion(int max_am1, int max_am2, int max_m)
    ...
    if (max_am2 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterMIRecursion -- max_am2 must be nonnegative", __FILE__,
                               __LINE__);
    //    if (max_m > 3)
    //        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterMIRecursion -- max_m must be nonnegative and less than
    //        4", __FILE__, __LINE__);
...
void ObaraSaikaTwoCenterMIRecursion::compute(double PA[3], double PB[3], double gamma, int am1, int am2) {
    if (am1 < 0 || am1 > max_am1_)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am1 out of bounds", __FILE__,
                               __LINE__);
    if (am2 < 0 || am2 > max_am2_)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterMIRecursion::compute -- am2 out of bounds", __FILE__,
                               __LINE__);
            ...
            for (by = 0; by <= b - bx; ++by) {
                ...
                if (bz > 0) {
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) { /* Electric field integrals */
                        ...
                        z_[0][bind][m] =
                            PB[2] * z_[0][bind - bzm][m] - PC[2] * z_[0][bind - bzm][m + 1] + q_[0][bind - bzm][m + 1];
                    }
                    for (m = 0; m <= mmax - b - 2; ++m) { /* Gradients of the electric field */
                        ...
                        zz_[0][bind][m] = PB[2] * zz_[0][bind - bzm][m] - PC[2] * zz_[0][bind - bzm][m + 1] +
                                          2 * z_[0][bind - bzm][m + 1];
                        xy_[0][bind][m] = PB[2] * xy_[0][bind - bzm][m] - PC[2] * xy_[0][bind - bzm][m + 1];
                        xz_[0][bind][m] = PB[2] * xz_[0][bind - bzm][m] - PC[2] * xz_[0][bind - bzm][m + 1] +
                                          x_[0][bind - bzm][m + 1];
                    ...
                    if (bz > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            q_[0][bind][m] +=
                                ooz * (bz - 1) * (q_[0][bind - 2 * bzm][m] - q_[0][bind - 2 * bzm][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            x_[0][bind][m] +=
                                ooz * (bz - 1) * (x_[0][bind - 2 * bzm][m] - x_[0][bind - 2 * bzm][m + 1]);
                            y_[0][bind][m] +=
                                ooz * (bz - 1) * (y_[0][bind - 2 * bzm][m] - y_[0][bind - 2 * bzm][m + 1]);
                            z_[0][bind][m] +=
                                ooz * (bz - 1) * (z_[0][bind - 2 * bzm][m] - z_[0][bind - 2 * bzm][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 2; m++) {
                            xx_[0][bind][m] +=
                                ooz * (bz - 1) * (xx_[0][bind - 2 * bzm][m] - xx_[0][bind - 2 * bzm][m + 1]);
                            yy_[0][bind][m] +=
                                ooz * (bz - 1) * (yy_[0][bind - 2 * bzm][m] - yy_[0][bind - 2 * bzm][m + 1]);
                            zz_[0][bind][m] +=
                                ooz * (bz - 1) * (zz_[0][bind - 2 * bzm][m] - zz_[0][bind - 2 * bzm][m + 1]);
                            xy_[0][bind][m] +=
                                ooz * (bz - 1) * (xy_[0][bind - 2 * bzm][m] - xy_[0][bind - 2 * bzm][m + 1]);
                            xz_[0][bind][m] +=
                                ooz * (bz - 1) * (xz_[0][bind - 2 * bzm][m] - xz_[0][bind - 2 * bzm][m + 1]);
                            yz_[0][bind][m] +=
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) {
                        ...
                        y_[0][bind][m] =
                            PB[1] * y_[0][bind - bym][m] - PC[1] * y_[0][bind - bym][m + 1] + q_[0][bind - bym][m + 1];
                        z_[0][bind][m] = PB[1] * z_[0][bind - bym][m] - PC[1] * z_[0][bind - bym][m + 1];
                    }
                    for (m = 0; m <= mmax - b - 2; m++) {
                        xx_[0][bind][m] = PB[1] * xx_[0][bind - bym][m] - PC[1] * xx_[0][bind - bym][m + 1];
                        yy_[0][bind][m] = PB[1] * yy_[0][bind - bym][m] - PC[1] * yy_[0][bind - bym][m + 1] +
                                          2 * y_[0][bind - bym][m + 1];
                        zz_[0][bind][m] = PB[1] * zz_[0][bind - bym][m] - PC[1] * zz_[0][bind - bym][m + 1];
                        xy_[0][bind][m] = PB[1] * xy_[0][bind - bym][m] - PC[1] * xy_[0][bind - bym][m + 1] +
                                          x_[0][bind - bym][m + 1];
                    ...
                    if (by > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            q_[0][bind][m] +=
                                ooz * (by - 1) * (q_[0][bind - 2 * bym][m] - q_[0][bind - 2 * bym][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            x_[0][bind][m] +=
                                ooz * (by - 1) * (x_[0][bind - 2 * bym][m] - x_[0][bind - 2 * bym][m + 1]);
                            y_[0][bind][m] +=
                                ooz * (by - 1) * (y_[0][bind - 2 * bym][m] - y_[0][bind - 2 * bym][m + 1]);
                            z_[0][bind][m] +=
                                ooz * (by - 1) * (z_[0][bind - 2 * bym][m] - z_[0][bind - 2 * bym][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 2; m++) {
                            xx_[0][bind][m] +=
                                ooz * (by - 1) * (xx_[0][bind - 2 * bym][m] - xx_[0][bind - 2 * bym][m + 1]);
                            yy_[0][bind][m] +=
                                ooz * (by - 1) * (yy_[0][bind - 2 * bym][m] - yy_[0][bind - 2 * bym][m + 1]);
                            zz_[0][bind][m] +=
                                ooz * (by - 1) * (zz_[0][bind - 2 * bym][m] - zz_[0][bind - 2 * bym][m + 1]);
                            xy_[0][bind][m] +=
                                ooz * (by - 1) * (xy_[0][bind - 2 * bym][m] - xy_[0][bind - 2 * bym][m + 1]);
                            xz_[0][bind][m] +=
                                ooz * (by - 1) * (xz_[0][bind - 2 * bym][m] - xz_[0][bind - 2 * bym][m + 1]);
                            yz_[0][bind][m] +=
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) {
                        x_[0][bind][m] =
                            PB[0] * x_[0][bind - bxm][m] - PC[0] * x_[0][bind - bxm][m + 1] + q_[0][bind - bxm][m + 1];
                        y_[0][bind][m] = PB[0] * y_[0][bind - bxm][m] - PC[0] * y_[0][bind - bxm][m + 1];
                        z_[0][bind][m] = PB[0] * z_[0][bind - bxm][m] - PC[0] * z_[0][bind - bxm][m + 1];
                    }
                    for (m = 0; m <= mmax - b - 2; m++) {
                        xx_[0][bind][m] = PB[0] * xx_[0][bind - bxm][m] - PC[0] * xx_[0][bind - bxm][m + 1] +
                                          2 * x_[0][bind - bxm][m + 1];
                        yy_[0][bind][m] = PB[0] * yy_[0][bind - bxm][m] - PC[0] * yy_[0][bind - bxm][m + 1];
                        zz_[0][bind][m] = PB[0] * zz_[0][bind - bxm][m] - PC[0] * zz_[0][bind - bxm][m + 1];
                        xy_[0][bind][m] = PB[0] * xy_[0][bind - bxm][m] - PC[0] * xy_[0][bind - bxm][m + 1] +
                                          y_[0][bind - bxm][m + 1];
                        xz_[0][bind][m] = PB[0] * xz_[0][bind - bxm][m] - PC[0] * xz_[0][bind - bxm][m + 1] +
                                          z_[0][bind - bxm][m + 1];
                    ...
                    if (bx > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            q_[0][bind][m] +=
                                ooz * (bx - 1) * (q_[0][bind - 2 * bxm][m] - q_[0][bind - 2 * bxm][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            x_[0][bind][m] +=
                                ooz * (bx - 1) * (x_[0][bind - 2 * bxm][m] - x_[0][bind - 2 * bxm][m + 1]);
                            y_[0][bind][m] +=
                                ooz * (bx - 1) * (y_[0][bind - 2 * bxm][m] - y_[0][bind - 2 * bxm][m + 1]);
                            z_[0][bind][m] +=
                                ooz * (bx - 1) * (z_[0][bind - 2 * bxm][m] - z_[0][bind - 2 * bxm][m + 1]);
                        }
                        for (m = 0; m <= mmax - b - 2; m++) {
                            xx_[0][bind][m] +=
                                ooz * (bx - 1) * (xx_[0][bind - 2 * bxm][m] - xx_[0][bind - 2 * bxm][m + 1]);
                            yy_[0][bind][m] +=
                                ooz * (bx - 1) * (yy_[0][bind - 2 * bxm][m] - yy_[0][bind - 2 * bxm][m + 1]);
                            zz_[0][bind][m] +=
                                ooz * (bx - 1) * (zz_[0][bind - 2 * bxm][m] - zz_[0][bind - 2 * bxm][m + 1]);
                            xy_[0][bind][m] +=
                                ooz * (bx - 1) * (xy_[0][bind - 2 * bxm][m] - xy_[0][bind - 2 * bxm][m + 1]);
                            xz_[0][bind][m] +=
                                ooz * (bx - 1) * (xz_[0][bind - 2 * bxm][m] - xz_[0][bind - 2 * bxm][m + 1]);
                            yz_[0][bind][m] +=
                        ...
                        for (ay = 0; ay <= a - ax; ay++) {
                            ...
                            if (az > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                    q_[aind][bind][m] =
                                        PA[2] * q_[aind - azm][bind][m] - PC[2] * q_[aind - azm][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    x_[aind][bind][m] =
                                        PA[2] * x_[aind - azm][bind][m] - PC[2] * x_[aind - azm][bind][m + 1];
                                    y_[aind][bind][m] =
                                        PA[2] * y_[aind - azm][bind][m] - PC[2] * y_[aind - azm][bind][m + 1];
                                    z_[aind][bind][m] = PA[2] * z_[aind - azm][bind][m] -
                                                        PC[2] * z_[aind - azm][bind][m + 1] +
                                                        q_[aind - azm][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 2; m++) {
                                    xx_[aind][bind][m] =
                                        PA[2] * xx_[aind - azm][bind][m] - PC[2] * xx_[aind - azm][bind][m + 1];
                                    yy_[aind][bind][m] =
                                        PA[2] * yy_[aind - azm][bind][m] - PC[2] * yy_[aind - azm][bind][m + 1];
                                    zz_[aind][bind][m] = PA[2] * zz_[aind - azm][bind][m] -
                                                         PC[2] * zz_[aind - azm][bind][m + 1] +
                                                         2 * z_[aind - azm][bind][m + 1];
                                    xy_[aind][bind][m] =
                                        PA[2] * xy_[aind - azm][bind][m] - PC[2] * xy_[aind - azm][bind][m + 1];
                                    xz_[aind][bind][m] = PA[2] * xz_[aind - azm][bind][m] -
                                                         PC[2] * xz_[aind - azm][bind][m + 1] +
                                                         x_[aind - azm][bind][m + 1];
                                    yz_[aind][bind][m] = PA[2] * yz_[aind - azm][bind][m] -
                                ...
                                if (az > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (q_[aind - 2 * azm][bind][m] - q_[aind - 2 * azm][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (x_[aind - 2 * azm][bind][m] - x_[aind - 2 * azm][bind][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (y_[aind - 2 * azm][bind][m] - y_[aind - 2 * azm][bind][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (z_[aind - 2 * azm][bind][m] - z_[aind - 2 * azm][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (xx_[aind - 2 * azm][bind][m] - xx_[aind - 2 * azm][bind][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (yy_[aind - 2 * azm][bind][m] - yy_[aind - 2 * azm][bind][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (zz_[aind - 2 * azm][bind][m] - zz_[aind - 2 * azm][bind][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (xy_[aind - 2 * azm][bind][m] - xy_[aind - 2 * azm][bind][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (xz_[aind - 2 * azm][bind][m] - xz_[aind - 2 * azm][bind][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                ...
                                if (bz > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * bz *
                                            (q_[aind - azm][bind - bzm][m] - q_[aind - azm][bind - bzm][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * bz *
                                            (x_[aind - azm][bind - bzm][m] - x_[aind - azm][bind - bzm][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * bz *
                                            (y_[aind - azm][bind - bzm][m] - y_[aind - azm][bind - bzm][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * bz *
                                            (z_[aind - azm][bind - bzm][m] - z_[aind - azm][bind - bzm][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * bz *
                                            (xx_[aind - azm][bind - bzm][m] - xx_[aind - azm][bind - bzm][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * bz *
                                            (yy_[aind - azm][bind - bzm][m] - yy_[aind - azm][bind - bzm][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * bz *
                                            (zz_[aind - azm][bind - bzm][m] - zz_[aind - azm][bind - bzm][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * bz *
                                            (xy_[aind - azm][bind - bzm][m] - xy_[aind - azm][bind - bzm][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * bz *
                                            (xz_[aind - azm][bind - bzm][m] - xz_[aind - azm][bind - bzm][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * bz *
                                ...
                                for (m = 0; m <= mmax - a - b; m++) {
                                    q_[aind][bind][m] =
                                        PA[1] * q_[aind - aym][bind][m] - PC[1] * q_[aind - aym][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    x_[aind][bind][m] =
                                        PA[1] * x_[aind - aym][bind][m] - PC[1] * x_[aind - aym][bind][m + 1];
                                    y_[aind][bind][m] = PA[1] * y_[aind - aym][bind][m] -
                                                        PC[1] * y_[aind - aym][bind][m + 1] +
                                                        q_[aind - aym][bind][m + 1];
                                    z_[aind][bind][m] =
                                        PA[1] * z_[aind - aym][bind][m] - PC[1] * z_[aind - aym][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 2; m++) {
                                    xx_[aind][bind][m] =
                                        PA[1] * xx_[aind - aym][bind][m] - PC[1] * xx_[aind - aym][bind][m + 1];
                                    yy_[aind][bind][m] = PA[1] * yy_[aind - aym][bind][m] -
                                                         PC[1] * yy_[aind - aym][bind][m + 1] +
                                                         2 * y_[aind - aym][bind][m + 1];
                                    zz_[aind][bind][m] =
                                        PA[1] * zz_[aind - aym][bind][m] - PC[1] * zz_[aind - aym][bind][m + 1];
                                    xy_[aind][bind][m] = PA[1] * xy_[aind - aym][bind][m] -
                                                         PC[1] * xy_[aind - aym][bind][m + 1] +
                                                         x_[aind - aym][bind][m + 1];
                                    xz_[aind][bind][m] =
                                        PA[1] * xz_[aind - aym][bind][m] - PC[1] * xz_[aind - aym][bind][m + 1];
                                    yz_[aind][bind][m] = PA[1] * yz_[aind - aym][bind][m] -
                                ...
                                if (ay > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (q_[aind - 2 * aym][bind][m] - q_[aind - 2 * aym][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (x_[aind - 2 * aym][bind][m] - x_[aind - 2 * aym][bind][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (y_[aind - 2 * aym][bind][m] - y_[aind - 2 * aym][bind][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (z_[aind - 2 * aym][bind][m] - z_[aind - 2 * aym][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (xx_[aind - 2 * aym][bind][m] - xx_[aind - 2 * aym][bind][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (yy_[aind - 2 * aym][bind][m] - yy_[aind - 2 * aym][bind][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (zz_[aind - 2 * aym][bind][m] - zz_[aind - 2 * aym][bind][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (xy_[aind - 2 * aym][bind][m] - xy_[aind - 2 * aym][bind][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (xz_[aind - 2 * aym][bind][m] - xz_[aind - 2 * aym][bind][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                ...
                                if (by > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * by *
                                            (q_[aind - aym][bind - bym][m] - q_[aind - aym][bind - bym][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * by *
                                            (x_[aind - aym][bind - bym][m] - x_[aind - aym][bind - bym][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * by *
                                            (y_[aind - aym][bind - bym][m] - y_[aind - aym][bind - bym][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * by *
                                            (z_[aind - aym][bind - bym][m] - z_[aind - aym][bind - bym][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * by *
                                            (xx_[aind - aym][bind - bym][m] - xx_[aind - aym][bind - bym][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * by *
                                            (yy_[aind - aym][bind - bym][m] - yy_[aind - aym][bind - bym][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * by *
                                            (zz_[aind - aym][bind - bym][m] - zz_[aind - aym][bind - bym][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * by *
                                            (xy_[aind - aym][bind - bym][m] - xy_[aind - aym][bind - bym][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * by *
                                            (xz_[aind - aym][bind - bym][m] - xz_[aind - aym][bind - bym][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * by *
                                ...
                                for (m = 0; m <= mmax - a - b; m++) {
                                    q_[aind][bind][m] =
                                        PA[0] * q_[aind - axm][bind][m] - PC[0] * q_[aind - axm][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    x_[aind][bind][m] = PA[0] * x_[aind - axm][bind][m] -
                                                        PC[0] * x_[aind - axm][bind][m + 1] +
                                                        q_[aind - axm][bind][m + 1];
                                    y_[aind][bind][m] =
                                        PA[0] * y_[aind - axm][bind][m] - PC[0] * y_[aind - axm][bind][m + 1];
                                    z_[aind][bind][m] =
                                        PA[0] * z_[aind - axm][bind][m] - PC[0] * z_[aind - axm][bind][m + 1];
                                }
                                for (m = 0; m <= mmax - a - b - 2; m++) { /* Gradients of the electric field */
                                    xx_[aind][bind][m] = PA[0] * xx_[aind - axm][bind][m] -
                                                         PC[0] * xx_[aind - axm][bind][m + 1] +
                                                         2 * x_[aind - axm][bind][m + 1];
                                    yy_[aind][bind][m] =
                                        PA[0] * yy_[aind - axm][bind][m] - PC[0] * yy_[aind - axm][bind][m + 1];
                                    zz_[aind][bind][m] =
                                        PA[0] * zz_[aind - axm][bind][m] - PC[0] * zz_[aind - axm][bind][m + 1];
                                    xy_[aind][bind][m] = PA[0] * xy_[aind - axm][bind][m] -
                                                         PC[0] * xy_[aind - axm][bind][m + 1] +
                                                         y_[aind - axm][bind][m + 1];
                                    xz_[aind][bind][m] = PA[0] * xz_[aind - axm][bind][m] -
                                                         PC[0] * xz_[aind - axm][bind][m + 1] +
                                                         z_[aind - axm][bind][m + 1];
                                    yz_[aind][bind][m] =
                                ...
                                if (ax > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (q_[aind - 2 * axm][bind][m] - q_[aind - 2 * axm][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (x_[aind - 2 * axm][bind][m] - x_[aind - 2 * axm][bind][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (y_[aind - 2 * axm][bind][m] - y_[aind - 2 * axm][bind][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (z_[aind - 2 * axm][bind][m] - z_[aind - 2 * axm][bind][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (xx_[aind - 2 * axm][bind][m] - xx_[aind - 2 * axm][bind][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (yy_[aind - 2 * axm][bind][m] - yy_[aind - 2 * axm][bind][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (zz_[aind - 2 * axm][bind][m] - zz_[aind - 2 * axm][bind][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (xy_[aind - 2 * axm][bind][m] - xy_[aind - 2 * axm][bind][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (xz_[aind - 2 * axm][bind][m] - xz_[aind - 2 * axm][bind][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                ...
                                if (bx > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        q_[aind][bind][m] +=
                                            ooz * bx *
                                            (q_[aind - axm][bind - bxm][m] - q_[aind - axm][bind - bxm][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        x_[aind][bind][m] +=
                                            ooz * bx *
                                            (x_[aind - axm][bind - bxm][m] - x_[aind - axm][bind - bxm][m + 1]);
                                        y_[aind][bind][m] +=
                                            ooz * bx *
                                            (y_[aind - axm][bind - bxm][m] - y_[aind - axm][bind - bxm][m + 1]);
                                        z_[aind][bind][m] +=
                                            ooz * bx *
                                            (z_[aind - axm][bind - bxm][m] - z_[aind - axm][bind - bxm][m + 1]);
                                    }
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        xx_[aind][bind][m] +=
                                            ooz * bx *
                                            (xx_[aind - axm][bind - bxm][m] - xx_[aind - axm][bind - bxm][m + 1]);
                                        yy_[aind][bind][m] +=
                                            ooz * bx *
                                            (yy_[aind - axm][bind - bxm][m] - yy_[aind - axm][bind - bxm][m + 1]);
                                        zz_[aind][bind][m] +=
                                            ooz * bx *
                                            (zz_[aind - axm][bind - bxm][m] - zz_[aind - axm][bind - bxm][m + 1]);
                                        xy_[aind][bind][m] +=
                                            ooz * bx *
                                            (xy_[aind - axm][bind - bxm][m] - xy_[aind - axm][bind - bxm][m + 1]);
                                        xz_[aind][bind][m] +=
                                            ooz * bx *
                                            (xz_[aind - axm][bind - bxm][m] - xz_[aind - axm][bind - bxm][m + 1]);
                                        yz_[aind][bind][m] +=
                                            ooz * bx *
...
ObaraSaikaTwoCenterRecursion::ObaraSaikaTwoCenterRecursion(int max_am1, int max_am2)
    : max_am1_(max_am1), max_am2_(max_am2) {
    if (max_am1 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterRecursion -- max_am1 must be nonnegative", __FILE__,
                               __LINE__);
    if (max_am2 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterRecursion -- max_am2 must be nonnegative", __FILE__,
                               __LINE__);
...
ObaraSaikaTwoCenterVIRecursion::ObaraSaikaTwoCenterVIRecursion(int max_am1, int max_am2)
    : max_am1_(max_am1), max_am2_(max_am2) {
    if (max_am1 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am1 must be nonnegative", __FILE__,
                               __LINE__);
    if (max_am2 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaTwoCenterVIRecursion -- max_am2 must be nonnegative", __FILE__,
                               __LINE__);
...
ObaraSaikaTwoCenterVIRecursion::~ObaraSaikaTwoCenterVIRecursion() { free_box(vi_, size_, size_); }
            ...
            for (by = 0; by <= b - bx; ++by) {
                ...
                if (bz > 0) {
                    ...
                    if (bz > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            vi_[0][bind][m] +=
                                ooz * (bz - 1) * (vi_[0][bind - 2 * bzm][m] - vi_[0][bind - 2 * bzm][m + 1]);
                        }
                    }
                } else if (by > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    if (by > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            vi_[0][bind][m] +=
                                ooz * (by - 1) * (vi_[0][bind - 2 * bym][m] - vi_[0][bind - 2 * bym][m + 1]);
                        }
                    }
                } else if (bx > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    if (bx > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                            vi_[0][bind][m] +=
                                ooz * (bx - 1) * (vi_[0][bind - 2 * bxm][m] - vi_[0][bind - 2 * bxm][m + 1]);
                        }
                    }
                }
            }
                    ...
                    for (ax = 0; ax <= a; ax++) {
                        for (ay = 0; ay <= a - ax; ay++) {
                            ...
                            if (az > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                    vi_[aind][bind][m] =
                                        PA[2] * vi_[aind - azm][bind][m] - PC[2] * vi_[aind - azm][bind][m + 1];
                                }
                                ...
                                if (az > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vi_[aind - 2 * azm][bind][m] - vi_[aind - 2 * azm][bind][m + 1]);
                                    }
                                }
                                if (bz > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * bz *
                                            (vi_[aind - azm][bind - bzm][m] - vi_[aind - azm][bind - bzm][m + 1]);
                                    }
                                }
                            } else if (ay > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                    vi_[aind][bind][m] =
                                        PA[1] * vi_[aind - aym][bind][m] - PC[1] * vi_[aind - aym][bind][m + 1];
                                }
                                if (ay > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vi_[aind - 2 * aym][bind][m] - vi_[aind - 2 * aym][bind][m + 1]);
                                    }
                                }
                                if (by > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * by *
                                            (vi_[aind - aym][bind - bym][m] - vi_[aind - aym][bind - bym][m + 1]);
                                    }
                                }
                            } else if (ax > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                    vi_[aind][bind][m] =
                                        PA[0] * vi_[aind - axm][bind][m] - PC[0] * vi_[aind - axm][bind][m + 1];
                                }
                                ...
                                if (ax > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vi_[aind - 2 * axm][bind][m] - vi_[aind - 2 * axm][bind][m + 1]);
                                    }
                                }
                                if (bx > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                            ooz * bx *
                                            (vi_[aind - axm][bind - bxm][m] - vi_[aind - axm][bind - bxm][m + 1]);
                                    }
                                }
                            }
                        }
...
void ObaraSaikaTwoCenterVIDerivRecursion::compute(double PA[3], double PB[3], double PC[3], double zeta, int am1,
                                                  int am2) {
    int a, b, m;
    int azm = 1;
    int aym = am1 + 1;
            ...
            for (by = 0; by <= b - bx; ++by) {
                ...
                if (bz > 0) {
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) {
                        ...
                        vz_[0][bind][m] = PB[2] * vz_[0][bind - bzm][m] - PC[2] * vz_[0][bind - bzm][m + 1] +
                                          vi_[0][bind - bzm][m + 1];
                    }
                    if (bz > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                        ...
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            vx_[0][bind][m] +=
                                ooz * (bz - 1) * (vx_[0][bind - 2 * bzm][m] - vx_[0][bind - 2 * bzm][m + 1]);
                            vy_[0][bind][m] +=
                                ooz * (bz - 1) * (vy_[0][bind - 2 * bzm][m] - vy_[0][bind - 2 * bzm][m + 1]);
                            vz_[0][bind][m] +=
                                ooz * (bz - 1) * (vz_[0][bind - 2 * bzm][m] - vz_[0][bind - 2 * bzm][m + 1]);
                        }
                    }
                } else if (by > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) {
                        ...
                        vy_[0][bind][m] = PB[1] * vy_[0][bind - bym][m] - PC[1] * vy_[0][bind - bym][m + 1] +
                                          vi_[0][bind - bym][m + 1];
                    ...
                    if (by > 1) {
                        ...
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            vx_[0][bind][m] +=
                                ooz * (by - 1) * (vx_[0][bind - 2 * bym][m] - vx_[0][bind - 2 * bym][m + 1]);
                            vy_[0][bind][m] +=
                                ooz * (by - 1) * (vy_[0][bind - 2 * bym][m] - vy_[0][bind - 2 * bym][m + 1]);
                            vz_[0][bind][m] +=
                                ooz * (by - 1) * (vz_[0][bind - 2 * bym][m] - vz_[0][bind - 2 * bym][m + 1]);
                        }
                    }
                } else if (bx > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    for (m = 0; m <= mmax - b - 1; ++m) {
                        vx_[0][bind][m] = PB[0] * vx_[0][bind - bxm][m] - PC[0] * vx_[0][bind - bxm][m + 1] +
                                          vi_[0][bind - bxm][m + 1];
                    ...
                    if (bx > 1) {
                        ...
                        for (m = 0; m <= mmax - b - 1; ++m) {
                            vx_[0][bind][m] +=
                                ooz * (bx - 1) * (vx_[0][bind - 2 * bxm][m] - vx_[0][bind - 2 * bxm][m + 1]);
                            vy_[0][bind][m] +=
                                ooz * (bx - 1) * (vy_[0][bind - 2 * bxm][m] - vy_[0][bind - 2 * bxm][m + 1]);
                            vz_[0][bind][m] +=
                                ooz * (bx - 1) * (vz_[0][bind - 2 * bxm][m] - vz_[0][bind - 2 * bxm][m + 1]);
                        }
                    }
                }
            }
                    ...
                    for (ax = 0; ax <= a; ax++) {
                        for (ay = 0; ay <= a - ax; ay++) {
                            ...
                            if (az > 0) {
                                ...
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    vx_[aind][bind][m] =
                                        PA[2] * vx_[aind - azm][bind][m] - PC[2] * vx_[aind - azm][bind][m + 1];
                                    vy_[aind][bind][m] =
                                        PA[2] * vy_[aind - azm][bind][m] - PC[2] * vy_[aind - azm][bind][m + 1];
                                    vz_[aind][bind][m] = PA[2] * vz_[aind - azm][bind][m] -
                                                         PC[2] * vz_[aind - azm][bind][m + 1] +
                                                         vi_[aind - azm][bind][m + 1];
                                }
                                ...
                                if (az > 1) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vx_[aind - 2 * azm][bind][m] - vx_[aind - 2 * azm][bind][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vy_[aind - 2 * azm][bind][m] - vy_[aind - 2 * azm][bind][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vz_[aind - 2 * azm][bind][m] - vz_[aind - 2 * azm][bind][m + 1]);
                                    }
                                }
                                if (bz > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * bz *
                                            (vx_[aind - azm][bind - bzm][m] - vx_[aind - azm][bind - bzm][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * bz *
                                            (vy_[aind - azm][bind - bzm][m] - vy_[aind - azm][bind - bzm][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * bz *
                                            (vz_[aind - azm][bind - bzm][m] - vz_[aind - azm][bind - bzm][m + 1]);
                                    }
                                }
                            } else if (ay > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                ...
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    vx_[aind][bind][m] =
                                        PA[1] * vx_[aind - aym][bind][m] - PC[1] * vx_[aind - aym][bind][m + 1];
                                    vy_[aind][bind][m] = PA[1] * vy_[aind - aym][bind][m] -
                                                         PC[1] * vy_[aind - aym][bind][m + 1] +
                                                         vi_[aind - aym][bind][m + 1];
                                    vz_[aind][bind][m] =
                                        PA[1] * vz_[aind - aym][bind][m] - PC[1] * vz_[aind - aym][bind][m + 1];
                                }
                                if (ay > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vx_[aind - 2 * aym][bind][m] - vx_[aind - 2 * aym][bind][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vy_[aind - 2 * aym][bind][m] - vy_[aind - 2 * aym][bind][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vz_[aind - 2 * aym][bind][m] - vz_[aind - 2 * aym][bind][m + 1]);
                                    }
                                }
                                if (by > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * by *
                                            (vx_[aind - aym][bind - bym][m] - vx_[aind - aym][bind - bym][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * by *
                                            (vy_[aind - aym][bind - bym][m] - vy_[aind - aym][bind - bym][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * by *
                                            (vz_[aind - aym][bind - bym][m] - vz_[aind - aym][bind - bym][m + 1]);
                                    }
                                }
                            } else if (ax > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                ...
                                for (m = 0; m <= mmax - a - b - 1; ++m) {
                                    vx_[aind][bind][m] = PA[0] * vx_[aind - axm][bind][m] -
                                                         PC[0] * vx_[aind - axm][bind][m + 1] +
                                                         vi_[aind - axm][bind][m + 1];
                                    vy_[aind][bind][m] =
                                        PA[0] * vy_[aind - axm][bind][m] - PC[0] * vy_[aind - axm][bind][m + 1];
                                    vz_[aind][bind][m] =
                                        PA[0] * vz_[aind - axm][bind][m] - PC[0] * vz_[aind - axm][bind][m + 1];
                                }
                                ...
                                if (ax > 1) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vx_[aind - 2 * axm][bind][m] - vx_[aind - 2 * axm][bind][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vy_[aind - 2 * axm][bind][m] - vy_[aind - 2 * axm][bind][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vz_[aind - 2 * axm][bind][m] - vz_[aind - 2 * axm][bind][m + 1]);
                                    }
                                }
                                if (bx > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        vx_[aind][bind][m] +=
                                            ooz * bx *
                                            (vx_[aind - axm][bind - bxm][m] - vx_[aind - axm][bind - bxm][m + 1]);
                                        vy_[aind][bind][m] +=
                                            ooz * bx *
                                            (vy_[aind - axm][bind - bxm][m] - vy_[aind - axm][bind - bxm][m + 1]);
                                        vz_[aind][bind][m] +=
                                            ooz * bx *
                                            (vz_[aind - axm][bind - bxm][m] - vz_[aind - axm][bind - bxm][m + 1]);
                                    }
                                }
                            }
                        }
...
void ObaraSaikaTwoCenterVIDeriv2Recursion::compute(double PA[3], double PB[3], double PC[3], double zeta, int am1,
                                                   int am2) {
    int a, b, m;
    int azm = 1;
    int aym = am1 + 1;
            ...
            for (by = 0; by <= b - bx; ++by) {
                ...
                if (bz > 0) {
                    ...
                    for (m = 0; m <= mmax - b - 2; ++m) { /* Gradients of the electric field */
                        ...
                        vzz_[0][bind][m] = PB[2] * vzz_[0][bind - bzm][m] - PC[2] * vzz_[0][bind - bzm][m + 1] +
                                           2 * vz_[0][bind - bzm][m + 1];
                        vxy_[0][bind][m] = PB[2] * vxy_[0][bind - bzm][m] - PC[2] * vxy_[0][bind - bzm][m + 1];
                        vxz_[0][bind][m] = PB[2] * vxz_[0][bind - bzm][m] - PC[2] * vxz_[0][bind - bzm][m + 1] +
                                           vx_[0][bind - bzm][m + 1];
                        vyz_[0][bind][m] = PB[2] * vyz_[0][bind - bzm][m] - PC[2] * vyz_[0][bind - bzm][m + 1] +
                                           vy_[0][bind - bzm][m + 1];
                    }
                    if (bz > 1) {
                        for (m = 0; m <= mmax - b; ++m) {
                        ...
                        for (m = 0; m <= mmax - b - 2; m++) {
                            vxx_[0][bind][m] +=
                                ooz * (bz - 1) * (vxx_[0][bind - 2 * bzm][m] - vxx_[0][bind - 2 * bzm][m + 1]);
                            vyy_[0][bind][m] +=
                                ooz * (bz - 1) * (vyy_[0][bind - 2 * bzm][m] - vyy_[0][bind - 2 * bzm][m + 1]);
                            vzz_[0][bind][m] +=
                                ooz * (bz - 1) * (vzz_[0][bind - 2 * bzm][m] - vzz_[0][bind - 2 * bzm][m + 1]);
                            vxy_[0][bind][m] +=
                                ooz * (bz - 1) * (vxy_[0][bind - 2 * bzm][m] - vxy_[0][bind - 2 * bzm][m + 1]);
                            vxz_[0][bind][m] +=
                                ooz * (bz - 1) * (vxz_[0][bind - 2 * bzm][m] - vxz_[0][bind - 2 * bzm][m + 1]);
                            vyz_[0][bind][m] +=
                                ooz * (bz - 1) * (vyz_[0][bind - 2 * bzm][m] - vyz_[0][bind - 2 * bzm][m + 1]);
                        }
                    }
                } else if (by > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    for (m = 0; m <= mmax - b - 2; m++) {
                        ...
                        vyy_[0][bind][m] = PB[1] * vyy_[0][bind - bym][m] - PC[1] * vyy_[0][bind - bym][m + 1] +
                                           2 * vy_[0][bind - bym][m + 1];
                        vzz_[0][bind][m] = PB[1] * vzz_[0][bind - bym][m] - PC[1] * vzz_[0][bind - bym][m + 1];
                        vxy_[0][bind][m] = PB[1] * vxy_[0][bind - bym][m] - PC[1] * vxy_[0][bind - bym][m + 1] +
                                           vx_[0][bind - bym][m + 1];
                        vxz_[0][bind][m] = PB[1] * vxz_[0][bind - bym][m] - PC[1] * vxz_[0][bind - bym][m + 1];
                        vyz_[0][bind][m] = PB[1] * vyz_[0][bind - bym][m] - PC[1] * vyz_[0][bind - bym][m + 1] +
                                           vz_[0][bind - bym][m + 1];
                    }
                    ...
                    if (by > 1) {
                        ...
                        for (m = 0; m <= mmax - b - 2; m++) {
                            vxx_[0][bind][m] +=
                                ooz * (by - 1) * (vxx_[0][bind - 2 * bym][m] - vxx_[0][bind - 2 * bym][m + 1]);
                            vyy_[0][bind][m] +=
                                ooz * (by - 1) * (vyy_[0][bind - 2 * bym][m] - vyy_[0][bind - 2 * bym][m + 1]);
                            vzz_[0][bind][m] +=
                                ooz * (by - 1) * (vzz_[0][bind - 2 * bym][m] - vzz_[0][bind - 2 * bym][m + 1]);
                            vxy_[0][bind][m] +=
                                ooz * (by - 1) * (vxy_[0][bind - 2 * bym][m] - vxy_[0][bind - 2 * bym][m + 1]);
                            vxz_[0][bind][m] +=
                                ooz * (by - 1) * (vxz_[0][bind - 2 * bym][m] - vxz_[0][bind - 2 * bym][m + 1]);
                            vyz_[0][bind][m] +=
                                ooz * (by - 1) * (vyz_[0][bind - 2 * bym][m] - vyz_[0][bind - 2 * bym][m + 1]);
                        }
                    }
                } else if (bx > 0) {
                    for (m = 0; m <= mmax - b; ++m) {
                    ...
                    for (m = 0; m <= mmax - b - 2; m++) {
                        vxx_[0][bind][m] = PB[0] * vxx_[0][bind - bxm][m] - PC[0] * vxx_[0][bind - bxm][m + 1] +
                                           2 * vx_[0][bind - bxm][m + 1];
                        ...
                        vxy_[0][bind][m] = PB[0] * vxy_[0][bind - bxm][m] - PC[0] * vxy_[0][bind - bxm][m + 1] +
                                           vy_[0][bind - bxm][m + 1];
                        vxz_[0][bind][m] = PB[0] * vxz_[0][bind - bxm][m] - PC[0] * vxz_[0][bind - bxm][m + 1] +
                                           vz_[0][bind - bxm][m + 1];
                    ...
                    if (bx > 1) {
                        ...
                        for (m = 0; m <= mmax - b - 2; m++) {
                            vxx_[0][bind][m] +=
                                ooz * (bx - 1) * (vxx_[0][bind - 2 * bxm][m] - vxx_[0][bind - 2 * bxm][m + 1]);
                            vyy_[0][bind][m] +=
                                ooz * (bx - 1) * (vyy_[0][bind - 2 * bxm][m] - vyy_[0][bind - 2 * bxm][m + 1]);
                            vzz_[0][bind][m] +=
                                ooz * (bx - 1) * (vzz_[0][bind - 2 * bxm][m] - vzz_[0][bind - 2 * bxm][m + 1]);
                            vxy_[0][bind][m] +=
                                ooz * (bx - 1) * (vxy_[0][bind - 2 * bxm][m] - vxy_[0][bind - 2 * bxm][m + 1]);
                            vxz_[0][bind][m] +=
                                ooz * (bx - 1) * (vxz_[0][bind - 2 * bxm][m] - vxz_[0][bind - 2 * bxm][m + 1]);
                            vyz_[0][bind][m] +=
                                ooz * (bx - 1) * (vyz_[0][bind - 2 * bxm][m] - vyz_[0][bind - 2 * bxm][m + 1]);
                        }
                    }
                }
            }
                    ...
                    for (ax = 0; ax <= a; ax++) {
                        for (ay = 0; ay <= a - ax; ay++) {
                            ...
                            if (az > 0) {
                                ...
                                for (m = 0; m <= mmax - a - b - 2; m++) { /* Gradients of the electric field */
                                    vxx_[aind][bind][m] =
                                        PA[2] * vxx_[aind - azm][bind][m] - PC[2] * vxx_[aind - azm][bind][m + 1];
                                    vyy_[aind][bind][m] =
                                        PA[2] * vyy_[aind - azm][bind][m] - PC[2] * vyy_[aind - azm][bind][m + 1];
                                    vzz_[aind][bind][m] = PA[2] * vzz_[aind - azm][bind][m] -
                                                          PC[2] * vzz_[aind - azm][bind][m + 1] +
                                                          2 * vz_[aind - azm][bind][m + 1];
                                    vxy_[aind][bind][m] =
                                        PA[2] * vxy_[aind - azm][bind][m] - PC[2] * vxy_[aind - azm][bind][m + 1];
                                    vxz_[aind][bind][m] = PA[2] * vxz_[aind - azm][bind][m] -
                                                          PC[2] * vxz_[aind - azm][bind][m + 1] +
                                                          vx_[aind - azm][bind][m + 1];
                                    vyz_[aind][bind][m] = PA[2] * vyz_[aind - azm][bind][m] -
                                                          PC[2] * vyz_[aind - azm][bind][m + 1] +
                                                          vy_[aind - azm][bind][m + 1];
                                }
                                ...
                                if (az > 1) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vxx_[aind - 2 * azm][bind][m] - vxx_[aind - 2 * azm][bind][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vyy_[aind - 2 * azm][bind][m] - vyy_[aind - 2 * azm][bind][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vzz_[aind - 2 * azm][bind][m] - vzz_[aind - 2 * azm][bind][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vxy_[aind - 2 * azm][bind][m] - vxy_[aind - 2 * azm][bind][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vxz_[aind - 2 * azm][bind][m] - vxz_[aind - 2 * azm][bind][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (vyz_[aind - 2 * azm][bind][m] - vyz_[aind - 2 * azm][bind][m + 1]);
                                    }
                                }
                                if (bz > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * bz *
                                            (vxx_[aind - azm][bind - bzm][m] - vxx_[aind - azm][bind - bzm][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * bz *
                                            (vyy_[aind - azm][bind - bzm][m] - vyy_[aind - azm][bind - bzm][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * bz *
                                            (vzz_[aind - azm][bind - bzm][m] - vzz_[aind - azm][bind - bzm][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * bz *
                                            (vxy_[aind - azm][bind - bzm][m] - vxy_[aind - azm][bind - bzm][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * bz *
                                            (vxz_[aind - azm][bind - bzm][m] - vxz_[aind - azm][bind - bzm][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * bz *
                                            (vyz_[aind - azm][bind - bzm][m] - vyz_[aind - azm][bind - bzm][m + 1]);
                                    }
                                }
                            } else if (ay > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                ...
                                for (m = 0; m <= mmax - a - b - 2; m++) {
                                    vxx_[aind][bind][m] =
                                        PA[1] * vxx_[aind - aym][bind][m] - PC[1] * vxx_[aind - aym][bind][m + 1];
                                    vyy_[aind][bind][m] = PA[1] * vyy_[aind - aym][bind][m] -
                                                          PC[1] * vyy_[aind - aym][bind][m + 1] +
                                                          2 * vy_[aind - aym][bind][m + 1];
                                    vzz_[aind][bind][m] =
                                        PA[1] * vzz_[aind - aym][bind][m] - PC[1] * vzz_[aind - aym][bind][m + 1];
                                    vxy_[aind][bind][m] = PA[1] * vxy_[aind - aym][bind][m] -
                                                          PC[1] * vxy_[aind - aym][bind][m + 1] +
                                                          vx_[aind - aym][bind][m + 1];
                                    vxz_[aind][bind][m] =
                                        PA[1] * vxz_[aind - aym][bind][m] - PC[1] * vxz_[aind - aym][bind][m + 1];
                                    vyz_[aind][bind][m] = PA[1] * vyz_[aind - aym][bind][m] -
                                                          PC[1] * vyz_[aind - aym][bind][m + 1] +
                                                          vz_[aind - aym][bind][m + 1];
                                }
                                if (ay > 1) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                        vi_[aind][bind][m] +=
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vxx_[aind - 2 * aym][bind][m] - vxx_[aind - 2 * aym][bind][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vyy_[aind - 2 * aym][bind][m] - vyy_[aind - 2 * aym][bind][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vzz_[aind - 2 * aym][bind][m] - vzz_[aind - 2 * aym][bind][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vxy_[aind - 2 * aym][bind][m] - vxy_[aind - 2 * aym][bind][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vxz_[aind - 2 * aym][bind][m] - vxz_[aind - 2 * aym][bind][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (vyz_[aind - 2 * aym][bind][m] - vyz_[aind - 2 * aym][bind][m + 1]);
                                    }
                                }
                                if (by > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * by *
                                            (vxx_[aind - aym][bind - bym][m] - vxx_[aind - aym][bind - bym][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * by *
                                            (vyy_[aind - aym][bind - bym][m] - vyy_[aind - aym][bind - bym][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * by *
                                            (vzz_[aind - aym][bind - bym][m] - vzz_[aind - aym][bind - bym][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * by *
                                            (vxy_[aind - aym][bind - bym][m] - vxy_[aind - aym][bind - bym][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * by *
                                            (vxz_[aind - aym][bind - bym][m] - vxz_[aind - aym][bind - bym][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * by *
                                            (vyz_[aind - aym][bind - bym][m] - vyz_[aind - aym][bind - bym][m + 1]);
                                    }
                                }
                            } else if (ax > 0) {
                                for (m = 0; m <= mmax - a - b; m++) {
                                ...
                                for (m = 0; m <= mmax - a - b - 2; m++) { /* Gradients of the electric field */
                                    vxx_[aind][bind][m] = PA[0] * vxx_[aind - axm][bind][m] -
                                                          PC[0] * vxx_[aind - axm][bind][m + 1] +
                                                          2 * vx_[aind - axm][bind][m + 1];
                                    vyy_[aind][bind][m] =
                                        PA[0] * vyy_[aind - axm][bind][m] - PC[0] * vyy_[aind - axm][bind][m + 1];
                                    vzz_[aind][bind][m] =
                                        PA[0] * vzz_[aind - axm][bind][m] - PC[0] * vzz_[aind - axm][bind][m + 1];
                                    vxy_[aind][bind][m] = PA[0] * vxy_[aind - axm][bind][m] -
                                                          PC[0] * vxy_[aind - axm][bind][m + 1] +
                                                          vy_[aind - axm][bind][m + 1];
                                    vxz_[aind][bind][m] = PA[0] * vxz_[aind - axm][bind][m] -
                                                          PC[0] * vxz_[aind - axm][bind][m + 1] +
                                                          vz_[aind - axm][bind][m + 1];
                                    vyz_[aind][bind][m] =
                                        PA[0] * vyz_[aind - axm][bind][m] - PC[0] * vyz_[aind - axm][bind][m + 1];
                                }
                                ...
                                if (ax > 1) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vxx_[aind - 2 * axm][bind][m] - vxx_[aind - 2 * axm][bind][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vyy_[aind - 2 * axm][bind][m] - vyy_[aind - 2 * axm][bind][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vzz_[aind - 2 * axm][bind][m] - vzz_[aind - 2 * axm][bind][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vxy_[aind - 2 * axm][bind][m] - vxy_[aind - 2 * axm][bind][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vxz_[aind - 2 * axm][bind][m] - vxz_[aind - 2 * axm][bind][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (vyz_[aind - 2 * axm][bind][m] - vyz_[aind - 2 * axm][bind][m + 1]);
                                    }
                                }
                                if (bx > 0) {
                                    for (m = 0; m <= mmax - a - b; m++) {
                                    ...
                                    for (m = 0; m <= mmax - a - b - 2; m++) {
                                        vxx_[aind][bind][m] +=
                                            ooz * bx *
                                            (vxx_[aind - axm][bind - bxm][m] - vxx_[aind - axm][bind - bxm][m + 1]);
                                        vyy_[aind][bind][m] +=
                                            ooz * bx *
                                            (vyy_[aind - axm][bind - bxm][m] - vyy_[aind - axm][bind - bxm][m + 1]);
                                        vzz_[aind][bind][m] +=
                                            ooz * bx *
                                            (vzz_[aind - axm][bind - bxm][m] - vzz_[aind - axm][bind - bxm][m + 1]);
                                        vxy_[aind][bind][m] +=
                                            ooz * bx *
                                            (vxy_[aind - axm][bind - bxm][m] - vxy_[aind - axm][bind - bxm][m + 1]);
                                        vxz_[aind][bind][m] +=
                                            ooz * bx *
                                            (vxz_[aind - axm][bind - bxm][m] - vxz_[aind - axm][bind - bxm][m + 1]);
                                        vyz_[aind][bind][m] +=
                                            ooz * bx *
                                            (vyz_[aind - axm][bind - bxm][m] - vyz_[aind - axm][bind - bxm][m + 1]);
                                    }
                                }
                            }
                        }
...
ObaraSaikaTwoCenterElectricField::ObaraSaikaTwoCenterElectricField(int max_am1, int max_am2)
    : ObaraSaikaTwoCenterVIRecursion(max_am1,
                                     max_am2)  // This is not used, because the elec deriv (3rd arg) needed is different
{
...
void ObaraSaikaTwoCenterElectricField::compute(double PA[3], double PB[3], double PC[3], double zeta, int am1,
                                               int am2) {
    int a, b, m;
    int azm = 1;
    int aym = am1 + 1;
...
void ObaraSaikaTwoCenterElectricFieldGradient::compute(double PA[3], double PB[3], double PC[3], double zeta, int am1,
                                                       int am2) {
    int a, b, m;
    int azm = 1;
    int aym = am1 + 1;
            ...
            for (by = 0; by <= b - bx; ++by) {
                ...
                if (bz > 0) {
                    for (m = 0; m <= mmax - b - 2; ++m) {
                        ...
                        ezz_[0][bind][m] = PB[2] * ezz_[0][bind - bzm][m] - PC[2] * ezz_[0][bind - bzm][m + 1] +
                                           2.0 * z_[0][bind - bzm][m + 1];
                        exy_[0][bind][m] = PB[2] * exy_[0][bind - bzm][m] - PC[2] * exy_[0][bind - bzm][m + 1];
                        exz_[0][bind][m] = PB[2] * exz_[0][bind - bzm][m] - PC[2] * exz_[0][bind - bzm][m + 1] +
                                           x_[0][bind - bzm][m + 1];
                        eyz_[0][bind][m] = PB[2] * eyz_[0][bind - bzm][m] - PC[2] * eyz_[0][bind - bzm][m + 1] +
                                           y_[0][bind - bzm][m + 1];
                    }
                    if (bz > 1) {
                        for (m = 0; m <= mmax - b - 2; ++m) {
                            exx_[0][bind][m] +=
                                ooz * (bz - 1) * (exx_[0][bind - 2 * bzm][m] - exx_[0][bind - 2 * bzm][m + 1]);
                            eyy_[0][bind][m] +=
                                ooz * (bz - 1) * (eyy_[0][bind - 2 * bzm][m] - eyy_[0][bind - 2 * bzm][m + 1]);
                            ezz_[0][bind][m] +=
                                ooz * (bz - 1) * (ezz_[0][bind - 2 * bzm][m] - ezz_[0][bind - 2 * bzm][m + 1]);
                            exy_[0][bind][m] +=
                                ooz * (bz - 1) * (exy_[0][bind - 2 * bzm][m] - exy_[0][bind - 2 * bzm][m + 1]);
                            exz_[0][bind][m] +=
                                ooz * (bz - 1) * (exz_[0][bind - 2 * bzm][m] - exz_[0][bind - 2 * bzm][m + 1]);
                            eyz_[0][bind][m] +=
                                ooz * (bz - 1) * (eyz_[0][bind - 2 * bzm][m] - eyz_[0][bind - 2 * bzm][m + 1]);
                        }
                    }
                } else if (by > 0) {
                    for (m = 0; m <= mmax - b - 2; ++m) {
                        exx_[0][bind][m] = PB[1] * exx_[0][bind - bym][m] - PC[1] * exx_[0][bind - bym][m + 1];
                        eyy_[0][bind][m] = PB[1] * eyy_[0][bind - bym][m] - PC[1] * eyy_[0][bind - bym][m + 1] +
                                           2.0 * y_[0][bind - bym][m + 1];
                        ezz_[0][bind][m] = PB[1] * ezz_[0][bind - bym][m] - PC[1] * ezz_[0][bind - bym][m + 1];
                        exy_[0][bind][m] = PB[1] * exy_[0][bind - bym][m] - PC[1] * exy_[0][bind - bym][m + 1] -
                                           x_[0][bind - bym][m + 1];
                        exz_[0][bind][m] = PB[1] * exz_[0][bind - bym][m] - PC[1] * exz_[0][bind - bym][m + 1];
                        eyz_[0][bind][m] = PB[1] * eyz_[0][bind - bym][m] - PC[1] * eyz_[0][bind - bym][m + 1] -
                                           z_[0][bind - bym][m + 1];
                    }
                    if (by > 1) {
                        for (m = 0; m <= mmax - b - 2; ++m) {
                            exx_[0][bind][m] +=
                                ooz * (by - 1) * (exx_[0][bind - 2 * bym][m] - exx_[0][bind - 2 * bym][m + 1]);
                            eyy_[0][bind][m] +=
                                ooz * (by - 1) * (eyy_[0][bind - 2 * bym][m] - eyy_[0][bind - 2 * bym][m + 1]);
                            ezz_[0][bind][m] +=
                                ooz * (by - 1) * (ezz_[0][bind - 2 * bym][m] - ezz_[0][bind - 2 * bym][m + 1]);
                            exy_[0][bind][m] +=
                                ooz * (by - 1) * (exy_[0][bind - 2 * bym][m] - exy_[0][bind - 2 * bym][m + 1]);
                            exz_[0][bind][m] +=
                                ooz * (by - 1) * (exz_[0][bind - 2 * bym][m] - exz_[0][bind - 2 * bym][m + 1]);
                            eyz_[0][bind][m] +=
                                ooz * (by - 1) * (eyz_[0][bind - 2 * bym][m] - eyz_[0][bind - 2 * bym][m + 1]);
                        }
                    }
                } else if (bx > 0) {
                    for (m = 0; m <= mmax - b - 2; ++m) {
                        exx_[0][bind][m] = PB[0] * exx_[0][bind - bxm][m] - PC[0] * exx_[0][bind - bxm][m + 1] +
                                           2.0 * x_[0][bind - bxm][m + 1];
                        ...
                        exy_[0][bind][m] = PB[0] * exy_[0][bind - bxm][m] - PC[0] * exy_[0][bind - bxm][m + 1] -
                                           y_[0][bind - bxm][m + 1];
                        exz_[0][bind][m] = PB[0] * exz_[0][bind - bxm][m] - PC[0] * exz_[0][bind - bxm][m + 1] -
                                           z_[0][bind - bxm][m + 1];
                    ...
                    if (bx > 1) {
                        for (m = 0; m <= mmax - b - 2; ++m) {
                            exx_[0][bind][m] +=
                                ooz * (bx - 1) * (exx_[0][bind - 2 * bxm][m] - exx_[0][bind - 2 * bxm][m + 1]);
                            eyy_[0][bind][m] +=
                                ooz * (bx - 1) * (eyy_[0][bind - 2 * bxm][m] - eyy_[0][bind - 2 * bxm][m + 1]);
                            ezz_[0][bind][m] +=
                                ooz * (bx - 1) * (ezz_[0][bind - 2 * bxm][m] - ezz_[0][bind - 2 * bxm][m + 1]);
                            exy_[0][bind][m] +=
                                ooz * (bx - 1) * (exy_[0][bind - 2 * bxm][m] - exy_[0][bind - 2 * bxm][m + 1]);
                            exz_[0][bind][m] +=
                                ooz * (bx - 1) * (exz_[0][bind - 2 * bxm][m] - exz_[0][bind - 2 * bxm][m + 1]);
                            eyz_[0][bind][m] +=
                                ooz * (bx - 1) * (eyz_[0][bind - 2 * bxm][m] - eyz_[0][bind - 2 * bxm][m + 1]);
                        }
                    }
                }
            }
                    ...
                    for (ax = 0; ax <= a; ax++) {
                        for (ay = 0; ay <= a - ax; ay++) {
                            ...
                            if (az > 0) {
                                for (m = 0; m <= mmax - a - b - 2; ++m) {
                                    exx_[aind][bind][m] =
                                        PA[2] * exx_[aind - azm][bind][m] - PC[2] * exx_[aind - azm][bind][m + 1];
                                    eyy_[aind][bind][m] =
                                        PA[2] * eyy_[aind - azm][bind][m] - PC[2] * eyy_[aind - azm][bind][m + 1];
                                    ezz_[aind][bind][m] = PA[2] * ezz_[aind - azm][bind][m] -
                                                          PC[2] * ezz_[aind - azm][bind][m + 1] -
                                                          2.0 * z_[aind - azm][bind][m + 1];
                                    exy_[aind][bind][m] =
                                        PA[2] * exy_[aind - azm][bind][m] - PC[2] * exy_[aind - azm][bind][m + 1];
                                    exz_[aind][bind][m] = PA[2] * exz_[aind - azm][bind][m] -
                                                          PC[2] * exz_[aind - azm][bind][m + 1] +
                                                          x_[aind - azm][bind][m + 1];
                                    eyz_[aind][bind][m] = PA[2] * eyz_[aind - azm][bind][m] -
                                                          PC[2] * eyz_[aind - azm][bind][m + 1] +
                                                          y_[aind - azm][bind][m + 1];
                                }
                                if (az > 1) {
                                    for (m = 0; m <= mmax - a - b - 2; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (exx_[aind - 2 * azm][bind][m] - exx_[aind - 2 * azm][bind][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (eyy_[aind - 2 * azm][bind][m] - eyy_[aind - 2 * azm][bind][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (ezz_[aind - 2 * azm][bind][m] - ezz_[aind - 2 * azm][bind][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (exy_[aind - 2 * azm][bind][m] - exy_[aind - 2 * azm][bind][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (exz_[aind - 2 * azm][bind][m] - exz_[aind - 2 * azm][bind][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * (az - 1) *
                                            (eyz_[aind - 2 * azm][bind][m] - eyz_[aind - 2 * azm][bind][m + 1]);
                                    }
                                }
                                if (bz > 0) {
                                    for (m = 0; m <= mmax - a - b - 2; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * bz *
                                            (exx_[aind - azm][bind - bzm][m] - exx_[aind - azm][bind - bzm][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * bz *
                                            (eyy_[aind - azm][bind - bzm][m] - eyy_[aind - azm][bind - bzm][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * bz *
                                            (ezz_[aind - azm][bind - bzm][m] - ezz_[aind - azm][bind - bzm][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * bz *
                                            (exy_[aind - azm][bind - bzm][m] - exy_[aind - azm][bind - bzm][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * bz *
                                            (exz_[aind - azm][bind - bzm][m] - exz_[aind - azm][bind - bzm][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * bz *
                                            (eyz_[aind - azm][bind - bzm][m] - eyz_[aind - azm][bind - bzm][m + 1]);
                                    }
                                }
                            } else if (ay > 0) {
                                for (m = 0; m <= mmax - a - b - 2; ++m) {
                                    exx_[aind][bind][m] =
                                        PA[1] * exx_[aind - aym][bind][m] - PC[1] * exx_[aind - aym][bind][m + 1];
                                    eyy_[aind][bind][m] = PA[1] * eyy_[aind - aym][bind][m] -
                                                          PC[1] * eyy_[aind - aym][bind][m + 1] -
                                                          2.0 * y_[aind - aym][bind][m + 1];
                                    ezz_[aind][bind][m] =
                                        PA[1] * ezz_[aind - aym][bind][m] - PC[1] * ezz_[aind - aym][bind][m + 1];
                                    exy_[aind][bind][m] = PA[1] * exy_[aind - aym][bind][m] -
                                                          PC[1] * exy_[aind - aym][bind][m + 1] +
                                                          x_[aind - aym][bind][m + 1];
                                    exz_[aind][bind][m] =
                                        PA[1] * exz_[aind - aym][bind][m] - PC[1] * exz_[aind - aym][bind][m + 1];
                                    eyz_[aind][bind][m] = PA[1] * eyz_[aind - aym][bind][m] -
                                                          PC[1] * eyz_[aind - aym][bind][m + 1] +
                                                          z_[aind - aym][bind][m + 1];
                                }
                                if (ay > 1) {
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (exx_[aind - 2 * aym][bind][m] - exx_[aind - 2 * aym][bind][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (eyy_[aind - 2 * aym][bind][m] - eyy_[aind - 2 * aym][bind][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (ezz_[aind - 2 * aym][bind][m] - ezz_[aind - 2 * aym][bind][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (exy_[aind - 2 * aym][bind][m] - exy_[aind - 2 * aym][bind][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (exz_[aind - 2 * aym][bind][m] - exz_[aind - 2 * aym][bind][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * (ay - 1) *
                                            (eyz_[aind - 2 * aym][bind][m] - eyz_[aind - 2 * aym][bind][m + 1]);
                                    }
                                }
                                if (by > 0) {
                                    for (m = 0; m <= mmax - a - b - 2; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * by *
                                            (exx_[aind - aym][bind - bym][m] - exx_[aind - aym][bind - bym][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * by *
                                            (eyy_[aind - aym][bind - bym][m] - eyy_[aind - aym][bind - bym][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * by *
                                            (ezz_[aind - aym][bind - bym][m] - ezz_[aind - aym][bind - bym][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * by *
                                            (exy_[aind - aym][bind - bym][m] - exy_[aind - aym][bind - bym][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * by *
                                            (exz_[aind - aym][bind - bym][m] - exz_[aind - aym][bind - bym][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * by *
                                            (eyz_[aind - aym][bind - bym][m] - eyz_[aind - aym][bind - bym][m + 1]);
                                    }
                                }
                            } else if (ax > 0) {
                                for (m = 0; m <= mmax - a - b - 2; ++m) {
                                    exx_[aind][bind][m] = PA[0] * exx_[aind - axm][bind][m] -
                                                          PC[0] * exx_[aind - axm][bind][m + 1] -
                                                          2.0 * x_[aind - axm][bind][m + 1];
                                    eyy_[aind][bind][m] =
                                        PA[0] * eyy_[aind - axm][bind][m] - PC[0] * eyy_[aind - axm][bind][m + 1];
                                    ezz_[aind][bind][m] =
                                        PA[0] * ezz_[aind - axm][bind][m] - PC[0] * ezz_[aind - axm][bind][m + 1];
                                    exy_[aind][bind][m] = PA[0] * exy_[aind - axm][bind][m] -
                                                          PC[0] * exy_[aind - axm][bind][m + 1] +
                                                          y_[aind - axm][bind][m + 1];
                                    exz_[aind][bind][m] = PA[0] * exz_[aind - axm][bind][m] -
                                                          PC[0] * exz_[aind - axm][bind][m + 1] +
                                                          z_[aind - axm][bind][m + 1];
                                    eyz_[aind][bind][m] =
                                        PA[0] * eyz_[aind - axm][bind][m] - PC[0] * eyz_[aind - axm][bind][m + 1];
                                }
                                if (ax > 1) {
                                    for (m = 0; m <= mmax - a - b - 1; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (exx_[aind - 2 * axm][bind][m] - exx_[aind - 2 * axm][bind][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (eyy_[aind - 2 * axm][bind][m] - eyy_[aind - 2 * axm][bind][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (ezz_[aind - 2 * axm][bind][m] - ezz_[aind - 2 * axm][bind][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (exy_[aind - 2 * axm][bind][m] - exy_[aind - 2 * axm][bind][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (exz_[aind - 2 * axm][bind][m] - exz_[aind - 2 * axm][bind][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * (ax - 1) *
                                            (eyz_[aind - 2 * axm][bind][m] - eyz_[aind - 2 * axm][bind][m + 1]);
                                    }
                                }
                                if (bx > 0) {
                                    for (m = 0; m <= mmax - a - b - 2; ++m) {
                                        exx_[aind][bind][m] +=
                                            ooz * bx *
                                            (exx_[aind - axm][bind - bxm][m] - exx_[aind - axm][bind - bxm][m + 1]);
                                        eyy_[aind][bind][m] +=
                                            ooz * bx *
                                            (eyy_[aind - axm][bind - bxm][m] - eyy_[aind - axm][bind - bxm][m + 1]);
                                        ezz_[aind][bind][m] +=
                                            ooz * bx *
                                            (ezz_[aind - axm][bind - bxm][m] - ezz_[aind - axm][bind - bxm][m + 1]);
                                        exy_[aind][bind][m] +=
                                            ooz * bx *
                                            (exy_[aind - axm][bind - bxm][m] - exy_[aind - axm][bind - bxm][m + 1]);
                                        exz_[aind][bind][m] +=
                                            ooz * bx *
                                            (exz_[aind - axm][bind - bxm][m] - exz_[aind - axm][bind - bxm][m + 1]);
                                        eyz_[aind][bind][m] +=
                                            ooz * bx *
                                            (eyz_[aind - axm][bind - bxm][m] - eyz_[aind - axm][bind - bxm][m + 1]);
                                    }
                                }
                            }
                        }
...
ObaraSaikaThreeCenterRecursion::ObaraSaikaThreeCenterRecursion(int max_am1, int max_am2, int max_am3)
    ...
    if (max_am1 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am1 must be nonnegative", __FILE__,
                               __LINE__);
    if (max_am2 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am2 must be nonnegative", __FILE__,
                               __LINE__);
    if (max_am3 < 0)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion -- max_am3 must be nonnegative", __FILE__,
                               __LINE__);
...
void ObaraSaikaThreeCenterRecursion::compute(double GA[3], double GB[3], double GC[3], double gamma, int amA, int amB,
                                             int amC) {
    if (amA < 0 || amA > max_am1_)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am1 out of bounds", __FILE__,
                               __LINE__);
    if (amB < 0 || amB > max_am2_)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am2 out of bounds", __FILE__,
                               __LINE__);
    if (amC < 0 || amC > max_am3_)
        throw SanityCheckError("ERROR: ObaraSaikaThreeCenterRecursion::compute -- am3 out of bounds", __FILE__,
                               __LINE__);
